 % Sistema de coordenadas terrestre con PSTricks
...
%\psframe(-2,-4)(7,7)
        ...
        \pstThreeDCoor[nameX=$\vec{\mu}_{ec}$,nameY=$\vec{\mu}_\bot$,nameZ=$\vec{\mu}_p$,xMax=6,yMax=6,zMax=6,linewidth=2pt,linecolor=gray]
        ...
        \pstThreeDPut({\rtang 0.7 mul},{\az 2 div},0){$\omega$}
        \pstThreeDEllipse[beginAngle=0,endAngle=\el](0,0,0)(\rang,\az,0)(\rang,\az,90)
        \pstThreeDPut(\rtang,\az,{90 -\el add 2 div}){$\delta$}
