 % Tensión y corriente en circuito inductivo puro con PSTricks
...
\begin{pspicture}(-0.4,-1.2)(1,1.2)
 ...
 \rput(-0.3,0){\shortstack{%
  ...
  \psplot[linecolor=red,linewidth=2pt]% 1 radian = 57.296 degrees
         {-0.2}{1}{x 360 mul cos}  % sin(2pi*t)
  \psplot[linecolor=blue,linewidth=2pt]%
      {-0.2}{1}{x 360 mul sin} % cos(2pi*t) %La corriente adelanta 90 grados a la tensión
   \cnode(0.2,0.309017){0.1}{Cos1}
   \cnode(0.45,0.309017){0.1}{Sin1}
   \ncline{->}{Cos1}{Sin1}%Tension origen de fases
   \naput{$\pi/2$}
\end{pspicture}
