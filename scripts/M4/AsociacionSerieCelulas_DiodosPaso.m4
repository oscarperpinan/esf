...
sepBox= sep/6#Separación del cajeado con el sistema a resaltar
   ...
   line right dimen_*2/3
	 ...
	 line from Origen up dimen_*2/3
	
	D1:diode(right_ to (Serie1,Here)); llabel(,D_1,); b_current(I_{D1})
	dot
	
	D2:diode(right_ to (Serie2,D1)); llabel(,D_2,);b_current(I_{D2})
	line down_ from D1.end to Serie1; dot;
	line down_ from D2.end to Serie2; dot;
