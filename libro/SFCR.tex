...
% \subsection{Normativa aplicable en España}

% En el momento de escritura de este documento, la legislación aplicable
% a un SFCR en España es la siguiente:

% \begin{itemize}


% \item RD. 1578/2008 \citep{RealDecreto2008}:

%   \begin{itemize}

%   \item Marca las primas por la venta de la energía producida.

%   \item Establece un procedimiento de convocatorias con cupos de
%     potencia y preasignación.

%   \item Establece dos tipos de SFCR (dos tipos de prima y cupos de
%     potencia).

%     \begin{itemize}
%     \item Tipo I. Instalaciones que estén ubicadas en cubiertas o
%       fachadas de construcciones fijas, cerradas, hechas de materiales
%       resistentes, dedicadas a usos residencial, de servicios,
%       comercial o industrial, incluidas las de carácter agropecuario;
%       o bien, instalaciones que estén ubicadas sobre estructuras fijas
%       de soporte que tengan por objeto un uso de cubierta de
%       aparcamiento o de sombreamiento, en ambos casos de áreas
%       dedicadas a alguno de los usos anteriores, y se encuentren
%       ubicadas en una parcela con referencia catastral urbana.
%     \item Tipo II. Instalaciones no incluidas en el tipo I anterior.
%     \end{itemize}

%     Recientemente este Real Decreto ha sido modificado en algunos
%     aspectos por el RD 1565/2010 \cite{RD1565-2010}, por el RD 14/2010
%     \cite{RD-14-2010} (cuya disposición adicional primera tiene el
%     título "Limitación de las horas equivalentes de funcionamiento de
%     las instalaciones fotovoltaicas") y por el RD. 1699/2011.

%   \end{itemize}

% \item RD. 1699/2011 \citep{RealDecreto2011}
%   \begin{itemize}
...
%     superior a $\SI{100}{\kW}$\footnote{Este Real Decreto define
%       la potencia nominal del SFCR como la suma de la potencia de los
%       inversores que intervienen en las tres fases de la instalación
%       en condiciones nominales de funcionamiento. Será esta definición
%       la empleada en todo el documento al referirnos a la potencia
%       nominal del SFCR, y se utilizará la expresión {}``potencia
%       nominal del generador'' para designar la potencia del generador
%       fotovoltaico.%
%     }, siendo 5 kW la potencia máxima admisible de un inversor
%     monofásico.
%   \item Describe los requisitos técnicos de conexión a red que un SFCR
%     debe cumplir\footnote{Hasta la publicación de este Real Decreto,
%       estos requisitos estaban recogidos en el derogado
%       RD. 1663/2000.}, dedicando especial atención a los sistemas de
%     seguridad eléctrica.
%   \item Simplifica las tramitaciones para la conexión de pequeñas
%     instalaciones de generación eléctrica.
%   \item Contempla la posibilidad de conexión en la red interior de un
%     consumidor y establece un plazo de cuatro meses para la publicación
%     de una propuesta de Real Decreto que regule las condiciones
%     administrativas, técnicas y económicas del consumo de la energía
%     eléctrica producida para consumo propio (previsiblemente mediante
%     un mecanismo de balance neto).
%   \item Fija el contrato-tipo que debe ser firmado por el usuario del
%     SFCR y la compañía eléctrica a la que se conecta el sistema.
%   \item Deroga el RD. 1663/2000 y modifica algunos aspectos del
%     RD. 1578/2008.
%   \end{itemize}


%   \nomenclature[BT]{BT}{Baja Tensión}\nomenclature[MT]{MT}{Media
%     Tensión}

% \item RD. 436/2004 \citep{RealDecreto2004}: establece los
%   procedimientos de legalización de un SFCR. Algunos de estos
%   procedimientos han sido actualizados por el RD 661/2007
%   \cite{RD-661-2007} y por el RD 1578/2008.

% \item Reglamento Electrotécnico de Baja Tensión (2002)
%   \citep{RD_842_2002}\nomenclature[REBT]{REBT}{Reglamento
%     Electrotécnico de Baja Tensión}.  Debe destacarse que no hay un
%   capítulo específico dedicado a los SFCR.

% \item Documento HE5 del Codigo Técnico de la Edificación
%   \citep{CodigoTecnico2006}.
...
a sombrear. 
% Es recomendable acudir a la referencia \citep{PV-database}
...
sexagesimales.  \nomenclature[alfa]{$\alpha$}{Ángulo de orientación de
  un generador fotovoltaico}\nomenclature[beta]{$\beta$}{Ángulo de
  inclinación de un generador fotovoltaico}
...
Este tratamiento es el adoptado en el Código Técnico de la Edificación
...
\end{enumerate}
Suponiendo que el diagrama de la figura \ref{fig:DiagramaSombraLejana}
...
%       Collares-Pereira y Rabl \citep{Collares-Pereira.Rabl1979} mientras
%       que para medias mensuales de valores diarios se emplea frecuentemente
%       la propuesta de Page \citep{Page1961}.}\tabularnewline
%     \midrule 
...
%       a partir de valores de irradiación global \citep{Collares-Pereira.Rabl1979}.}\tabularnewline
%     \midrule 
...
%       anisotrópico recomendable es el de Hay y McKay \citep{Hay.McKay1985}.}\tabularnewline
%     \midrule 
...
%       y Ruiz \citep{Martin.Ruiz2001}.}\tabularnewline
%     \midrule
...
% anual global en el plano horizontal \citep{Caamano1998,Lorenzo2002,
