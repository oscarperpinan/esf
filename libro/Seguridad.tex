...
\nomenclature[Rtp]{$R_{tp}$}{Resistencia de puesta a tierra de una pica vertical}
\nomenclature[Rtc]{$R_{tc}$}{Resistencia de puesta a tierra de un conductor enterrado horizontalmente}
\nomenclature[rho_t]{$\rho$}{Resistividad del terreno}
\nomenclature[Lpica]{$L_{p}$}{Longitud de una pica de puesta a tierra}
\nomenclature[Lcond]{$L_{c}$}{Longitud de un conductor enterrado
  horizontalmente en una puesta a tierra} 
%
\begin{table}
...
Para obtener un determinado valor de resistencia de la puesta a
...
\nomenclature[Rp]{$R_{p}$}{Resistencia de un sistema de puesta a tierra}
...
%
\begin{figure}
  \subfloat[Caja de protecciones]{\includegraphics[scale=0.5]{../figs/CajaProteccionesPhotocampa}}
  \hspace{1cm}
  \subfloat[Esquema eléctrico]{\includegraphics[scale=0.8]{../figs/proteccionesDC}}
