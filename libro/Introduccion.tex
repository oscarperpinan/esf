...
\includegraphics[scale=0.25]{../Fotos/EstructuraEstaticaSuelo}
\par\end{centering}

}\hfill{}\subfloat[Sistema conectado a red instalado como acristalamiento de un edificio.\label{fig:SistemaEdificacion}]{\includegraphics[scale=0.46]{../Fotos/Torreguil}
...
\begin{figure}
\begin{centering}
\includegraphics[scale=0.6]{../Fotos/TelefoniaRural}
\end{centering}
