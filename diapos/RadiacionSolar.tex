...
\label{sec:org1902809}

\begin{frame}[label={sec:org51dd27d}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orga95a80d}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org0bafcde}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org05b4bd3}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgc606b79}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org9dba50c}
\subsection{Movimiento Sol-Tierra}
\label{sec:org1477715}

\begin{frame}[label={sec:org570dbf4}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:orge4c68f0}]{Movimiento terrestre}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlanoEcliptica.pdf}
\end{center}
...
\label{sec:org266990f}

\begin{frame}[label={sec:org190f7c3},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:org30fd895}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgc3168b6}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgefb355e}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org398758e}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org87ede8d},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2ca71f9}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:orgfedbcb3},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org04d1102},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org7a178a2}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org9b57a1d}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orgea9ad38}
\begin{frame}[label={sec:org5cec4e9}]{Hora solar}
...
\begin{frame}[label={sec:org65e6e1f}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:orge632140}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:org456f7e4}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:orgc510987}]{Ejemplo de cálculo}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org7ea2dc7}]{Solución}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org4945d28}]{}
\begin{center}
...
\label{sec:org94e6d1c}

\subsection{Radiación Extra-atmosférica}
\label{sec:orga88e621}

\begin{frame}[label={sec:orgf9978c8}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:orgbf5425f}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6d86c59}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgaf9f659}]{Días promedio}
\begin{itemize}
...
\label{sec:orgb038a4b}
\begin{frame}[label={sec:orgafadc81}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgca23648}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org3f47e9f}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org56da441}]{Cómo se escribe}
...
\begin{frame}[label={sec:org1592376}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orgb9b18cd}

\begin{frame}[label={sec:orgdc65479}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org12ab198}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org0f62e5e}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org10bc56e}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:orgd173f39},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orgfaaf368}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
...
\begin{frame}[label={sec:org1137048},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:orgb225f18}]{Ejemplo}
\begin{description}
...
\label{sec:org48033dd}
\subsection{Introducción}
\label{sec:orgd9c3892}
\begin{frame}[label={sec:orga200d0a}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0b95ace}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:orgf011a78}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org2bf816c}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgea90a20}]{Resumen}
...
\label{sec:org35e0365}
\begin{frame}[label={sec:orgf32bfa2}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org1b96d23}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org8f23b1b}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:orge7ef697}]{Fuentes de Datos}
...
\label{sec:org7cef574}
\begin{frame}[label={sec:org095cb52}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org289f42c}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org706ca0a}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:orgb233f63}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org3ed96ff}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:orgbdb245b}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:org83da794}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:orge90b716}

\subsection{Introducción}
\label{sec:org24ed690}

\begin{frame}[label={sec:org1c4202c}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orge62ae3f}]{Definiciones}
\begin{itemize}
...
\label{sec:org2d8022c}
\begin{frame}[label={sec:org10106a9}]{Sistema Estático}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5e65a3a}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org29e21c2}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org8950ab9}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2ffc999}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org9e00d1b}
\begin{frame}[label={sec:org0627bab}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6ccc35c}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgeee65ba}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org4660f5b}]{Ecuaciones}
\[
...
\label{sec:orgeb05e03}

\begin{frame}[label={sec:orgdcaab26}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0f06fbc}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2d873c}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org57583d5}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:org77645c9}]{Irradiancia Difusa Isotrópica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:org01c3932}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:org4e52717}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\label{sec:orgd522a30}
\begin{frame}[label={sec:org47d778e},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org53df455}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org03cbb3c},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:org44cd8e7}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org76cd5f2}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org1feef2c},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org00d691c}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org52c39f0}

\begin{frame}[label={sec:orgc6bd515}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8dc06e4}]{Radiación directa}
...
\begin{frame}[label={sec:org5f39115}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org07e0f7d}]{Pérdidas anuales}
\begin{center}
...
\label{sec:orgde57f75}

\begin{frame}[label={sec:orgefad744}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org2d49785}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org44f4b90}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org96f9edb}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orgb365564}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orge8e9c90}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:orgfd8abe7}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb54ead0}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:org74d264b}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
