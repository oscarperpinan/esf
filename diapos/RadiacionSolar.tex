...
\label{sec:org3a005e4}

\begin{frame}[label={sec:orgd55c291}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org01c650f}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org4d8b2a1}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org57a578f}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org1856a0f}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:orgf18a2df}
\subsection{Movimiento Sol-Tierra}
\label{sec:orgd744158}

\begin{frame}[label={sec:org93c57fa}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org5212d07}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgaba390b}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2cc6fe}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7fc88cb},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0652916}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org190fdc2},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org7f6ae4e},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org224c66a}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org56f64ee}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orga36adad}
\begin{frame}[label={sec:org7abbc9a}]{Hora solar}
...
\begin{frame}[label={sec:org6767d7c}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfc373bf}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orga5f8dd2}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org273f5c3}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org8ff545c}]{Cómo se escribe}
...
\begin{frame}[label={sec:orgf20e6dc}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orgefe68c9}

\begin{frame}[label={sec:org09511fb}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org38db9bf}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgcc15c87}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:orgf54e01a}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:org47b9f53}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgaa97676}]{Resumen}
...
\label{sec:org6522a66}
\begin{frame}[label={sec:org43257b9}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org555548e}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:orgf509293}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:orge3685de}]{Fuentes de Datos}
...
\label{sec:org83e75c0}
\begin{frame}[label={sec:org7d52fb6}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org6336b92}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org6167319}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org6801887}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org2b48f43}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf03f0fa}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\label{sec:org63d21a7}

\begin{frame}[label={sec:org2ff04c8}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org0e0e5b9}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orgf989fc9}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org97cce8d}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orga96363b}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org7ccf2cb}]{Comparación Eje Horizontal - Estática}
\begin{center}
