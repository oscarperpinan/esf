...
\label{sec:orgd4a3dbe}

\begin{frame}[label={sec:orgd3ff19e}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgeb89fd6}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orge7336f0}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org314a8ee}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgbbf4243}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org0af47fa}
\subsection{Movimiento Sol-Tierra}
\label{sec:orgafbf829}

\begin{frame}[label={sec:orgf64e1d0}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org871c5cd}]{Movimiento terrestre}
\begin{columns}
...
\label{sec:org93ad65e}

\begin{frame}[label={sec:orge1b2c2c},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:orge5aed0e}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgcb62dcc}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgbf8da1c}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org8b6c153}]{Duración del día}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org13e1e82},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org50870b1}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:orgcf02fe5},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:orgacc8a7f},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:orgb2509fa}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:orga189aa4}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orgb4c6d58}
\begin{frame}[label={sec:orgd144f01}]{Hora solar}
...
\begin{frame}[label={sec:org362b5c7}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org063a48b}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:org6302371}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:orgbf059b5}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:org434f5c9}]{}
\begin{center}
...
\label{sec:org1d468c5}

\subsection{Radiación Extra-atmosférica}
\label{sec:org487b16c}

\begin{frame}[label={sec:org1a32217}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:org590d67d}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf0f5d5f}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgcb66c63}]{Días promedio}
\begin{itemize}
...
\begin{frame}[label={sec:org206b073}]{Ejemplo de cálculo}
...
\label{sec:org8f7c96f}
\begin{frame}[label={sec:org00e630c}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbaab961}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org35326db}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org6fb88dc}]{Cómo se escribe}
...
\begin{frame}[label={sec:org163a8b6}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orge7f2ddc}

\begin{frame}[label={sec:org5df00d0}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga74da49}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org7e3473d}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:orge0098a7}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:org6370f44},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:org8ec17be}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:org6ef8b06},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:orge78c6a1}]{Ejemplo de cálculo}
...
\label{sec:orgc8684d8}
\subsection{Introducción}
\label{sec:org0dc3cd8}
\begin{frame}[label={sec:orgc5af688}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9484f7d}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:orgbb6873b}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org1d0519b}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgff3383c}]{Resumen}
...
\label{sec:orga1a3785}
\begin{frame}[label={sec:orga955b6d}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:orgfa06ede}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org94d7ea0}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org59abae8}]{Fuentes de Datos}
...
\label{sec:org0992088}
\begin{frame}[label={sec:orgc415796}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:orgbe5c582}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgcdc27d1}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org7911b4a}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org132374e}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org5102219}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:org61bf834}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:org23864c6}

\subsection{Introducción}
\label{sec:org3b055ea}

\begin{frame}[label={sec:org72354a3}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org51b2964}]{Definiciones}
\begin{itemize}
...
\label{sec:org9b10875}
\begin{frame}[label={sec:org78c7d94}]{Sistema Estático}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd1da492}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org72a6019}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgc5af700}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb2cae06}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org7df2edc}
\begin{frame}[label={sec:org5e9e0a7},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org67a4f0e}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgeeb3d10},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:org83f2c1a}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgd803207}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org8cc6e56},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org17cb504}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org4413f6f}
\begin{frame}[label={sec:org01a3dc8}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga6b6499}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org5d3fc6b}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org4ccfd78}]{Ecuaciones}
\[
...
\begin{frame}[label={sec:orga724e38}]{Ejemplo de cálculo}
...
\label{sec:org8076a5f}

\begin{frame}[label={sec:org3cae348}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0bdc1d4}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org2103807}]{Irradiancia Directa}
...
\begin{frame}[label={sec:orge66bd4c}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:org73a55d7}]{Irradiancia Difusa Isotrópica}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org9c98aca}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:org23b83a1}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[height=0.55\textheight]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\begin{frame}[label={sec:orgd64fcaf}]{Ejemplo de cálculo}
...
\label{sec:orge84922a}

\begin{frame}[label={sec:orgad9c003}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1cacba1}]{Radiación directa}
...
\begin{frame}[label={sec:org57a9622}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org086e4ab}]{Pérdidas anuales}
\begin{center}
...
\label{sec:org0ec8f1c}

\begin{frame}[label={sec:org00b9470}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org5be2694}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orgfb4cc43}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org27652a0}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orga259b2b}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org0d45164}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:orgb0a515e}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org41a20d4}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:org8b18be7}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Kahoot_Logo.png}
\end{center}
