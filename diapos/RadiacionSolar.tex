...
\label{sec:orgb848070}

\begin{frame}[label={sec:org67d2332}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org4b242e1}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org6ab991a}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orgc4b46fc}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgd55c46e}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org6b561ef}
\subsection{Movimiento Sol-Tierra}
\label{sec:org61351f4}

\begin{frame}[label={sec:orgd5dd4c1}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org8521792}]{Movimiento terrestre}
\begin{columns}
...
\label{sec:org4257860}

\begin{frame}[label={sec:org30539aa},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:org8587b7b}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgafe4fe0}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org61db825}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org5d8a307}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2810d6b},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org53d7de4}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org19a8dc8},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org9c94d47},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org8277730}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:orgd08c486}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:org77275b4}
\begin{frame}[label={sec:org679e8ff}]{Hora solar}
...
\begin{frame}[label={sec:org48fee9e}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org930da0e}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgab023f9}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:orge42ca4d}]{Ejemplo de cálculo}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org73b429d}]{Solución}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org5d55f61}]{}
\begin{center}
...
\label{sec:orga061878}

\subsection{Radiación Extra-atmosférica}
\label{sec:org347b098}

\begin{frame}[label={sec:orga556f8d}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:org0f2ffbd}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcecf683}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org6e3d231}]{Días promedio}
\begin{itemize}
...
\begin{frame}[label={sec:org61f0dd0}]{Ejemplo}
...
\label{sec:orgff30538}
\begin{frame}[label={sec:orgb4cdb64}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org18bebf7}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org7e73ca4}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org82f6b62}]{Cómo se escribe}
...
\begin{frame}[label={sec:orgc2f6fa9}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orga11d883}

\begin{frame}[label={sec:org09c38a3}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5c2f1af}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgd7648a8}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org8cb86b0}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:orgf920364},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orge41c64e}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
...
\begin{frame}[label={sec:org8c1e3ae},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:orgae92782}]{Ejemplo}
Calcular las componentes directa y difusa de la radiación solar del 17
...
\label{sec:org6013ee3}
\subsection{Introducción}
\label{sec:org7293ae8}
\begin{frame}[label={sec:org01f7e61}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8c37cbe}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:org7d46422}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org034d0f3}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org7c96eec}]{Resumen}
...
\label{sec:org0aa8479}
\begin{frame}[label={sec:orga758fc3}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:orga1a67c7}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:orge542d4c}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:orgc45033a}]{Fuentes de Datos}
...
\label{sec:org006612b}
\begin{frame}[label={sec:org337c427}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org9807fff}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2707d2}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org2bbeee2}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgaaee3ec}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:orga8c9282}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:orga622e0b}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:org41e681e}

\subsection{Introducción}
\label{sec:org7d56dfd}

\begin{frame}[label={sec:org0187ffd}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org5920679}]{Definiciones}
\begin{itemize}
...
\label{sec:orgba81889}
\begin{frame}[label={sec:org8fe9679}]{Sistema Estático}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgecf0003}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org10c71d3}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgb218d79}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga45d691}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org36421bf}
\begin{frame}[label={sec:orgbc80554}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgeb1e1b3}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org4ef25e5}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org7cbbb51}]{Ecuaciones}
\[
...
\label{sec:org0f23918}

\begin{frame}[label={sec:org8eabf79}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgff8e60a}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org8fd02ec}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org1ce4f11}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:org6c38b0e}]{Irradiancia Difusa Isotrópica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:orgcf8446a}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:orgfade888}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\label{sec:org021df85}
\begin{frame}[label={sec:org58263e9},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org8624dba}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org508695b},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:orgfd8e592}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgfd12709}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org9e4daee},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgca55333}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:orgd82d945}

\begin{frame}[label={sec:org9a591a8}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgec8aba9}]{Radiación directa}
...
\begin{frame}[label={sec:org9aee2d8}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org3ca453c}]{Pérdidas anuales}
\begin{center}
...
\label{sec:org8db5bf4}

\begin{frame}[label={sec:org3516cf0}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:orgb93643d}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org9aa7d54}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org6793b13}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orga19b9e1}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orgc32e377}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:orgf581c16}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3bf7f3d}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:org6db1af5}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
