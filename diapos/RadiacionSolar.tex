...
\label{sec:orgc171f17}

\begin{frame}[label={sec:org2294765}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org39b7723}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orgc18d785}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org03efb16}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgf726328}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org272f30e}
\subsection{Movimiento Sol-Tierra}
\label{sec:org6a342e9}

\begin{frame}[label={sec:org8d1d433}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:orgd84f673}]{Movimiento terrestre}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlanoEcliptica.pdf}
\end{center}
...
\label{sec:org20c2feb}

\begin{frame}[plain,label={sec:orge2d87f1}]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:orgf73ea3a}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgd631a09}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org3b9f5f2}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgc670330}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[plain,label={sec:org15433ec}]{Ejes locales}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0811d3d}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[plain,label={sec:org69292d2}]{Cenit Solar}
\[
...
\begin{frame}[plain,label={sec:org0e00469}]{Azimut solar}
\[
...
\begin{frame}[label={sec:orgfaf46a6}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org240e965}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\begin{frame}[label={sec:org84297d9}]{Cálculo Ángulos Solares}
\begin{itemize}
...
\label{sec:orgb684e51}
\begin{frame}[label={sec:orga9196bc}]{Hora solar}
...
\begin{frame}[label={sec:org2f191c0}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org9f622b7}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgb9327c9}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:org4d6ed97}]{Ejemplo de cálculo}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org6539134}]{Solución}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\label{sec:orgbda50b7}
\begin{frame}[label={sec:org1dfc968}]{Definiciones}
\begin{itemize}
...
\label{sec:org611ac8d}

\begin{frame}[label={sec:org2e93f56}]{Sistema Estático}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[plain,label={sec:orgc8dd008}]{Ángulo de Incidencia}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org9521001}]{Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org829f664}

\begin{frame}[label={sec:orgf7d0eac}]{Introducción}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf4bd8c9}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orge4403f2}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
...
\begin{frame}[plain,label={sec:orgbc9a7a8}]{Ángulo de Incidencia (1x eje, horizontal N-S)}
...
\begin{frame}[label={sec:orge020318}]{Inclinación de Eje Horizontal N-S}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org58c6767}]{Ángulo de Incidencia de Eje Horizontal N-S}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org04a1c5e}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorReocin.jpg}
\end{center}
\end{frame}

\begin{frame}[plain,label={sec:org20d59f1}]{Ángulo de Incidencia (seguidor 2x)}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgf734965}]{Inclinación (seguidor 2x)}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org98a6040}]{Ejercicio: cálculo de ángulo de incidencia}
\begin{description}
...
\label{sec:orgb362e1b}
\begin{frame}[label={sec:org2e6254e}]{Irradiancia e Irradiación}
\begin{description}
...
\label{sec:org83d38a8}


\begin{frame}[label={sec:orgdcf4c4f}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:orgb34920a}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgb4b6ea7}]{Días promedio}
\begin{itemize}
...
\label{sec:orgf9008f8}
\begin{frame}[label={sec:org0ffab58}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2e05784}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org552b917}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org8ca1ed4}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:orgb17773a}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgea2f742}]{Cómo se escribe}
...
\begin{frame}[label={sec:orgb16f22c}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orgb01ca2e}

\begin{frame}[label={sec:org2ee110c}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9ddf9ac}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:org87804cd}]{Correlaciones \(F_{D}\) y \(K_{T}\): Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orga15e0b3}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
...
\begin{frame}[label={sec:org5424630}]{Correlaciones \(F_{D}\) y \(K_{T}\): Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:org18f27fb}]{Ejemplo}
\begin{description}
...
\label{sec:orgb99447d}
\subsection{Introducción}
\label{sec:orgcd3df49}
\begin{frame}[label={sec:orgd33f2a8}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1ac2aee}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:orgc348809}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org9619d97}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org03e35b8}]{Resumen}
...
\label{sec:orga6eec6b}
\begin{frame}[label={sec:org4b6ddf2}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org999ba41}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org37a393c}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org6bbc5dd}]{Fuentes de Datos}
...
\label{sec:orgd90e786}
\begin{frame}[label={sec:org5057a8c}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org2c4907d}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org61d8e2b}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org846a271}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org36cad81}]{Métricas}
\begin{itemize}
...
\label{sec:orga0aedea}

\subsection{Introducción}
\label{sec:org83a64d7}

\begin{frame}[label={sec:orgdfe45ba}]{Ángulo de Inclinación}
\begin{itemize}
...
\label{sec:org1de997e}
\begin{frame}[label={sec:orga6e0eda}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgde88b72}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgb02c68a}]{Perfil}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/RgRd.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4eddd81}]{Ecuaciones del perfil}
...
\begin{frame}[label={sec:org73ac05c}]{Ejercicio}
\begin{description}
...
\label{sec:org54fa1df}

\begin{frame}[label={sec:org32be1ef}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgaa6fa66}]{Planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfda7894}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org2b75e39}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:orgacb6c10}]{Irradiancia Difusa Isotrópica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:org956b332}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:orgdea174f}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\begin{frame}[label={sec:org00d0d2c}]{Ejercicio}
\begin{description}
...
\label{sec:org7bb2726}

\begin{frame}[label={sec:orgda8bc63}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org447fb2f}]{Radiación directa}
...
\begin{frame}[label={sec:orgca6061c}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org3867000}]{Pérdidas anuales}
\begin{center}
...
\label{sec:orgd71fd54}

\begin{frame}[label={sec:org335d2f1}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org6de1cb5}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orgde155f4}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:orga26a357}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:org809e655}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org412e66b}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:orgbdd85af}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org039df39}]{Comparación entre Sistemas}
\begin{center}
