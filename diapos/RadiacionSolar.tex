...
\begin{frame}[label={sec:orgf6cf847}]{Radiación Extra-atmosférica}
\begin{itemize}
...
\begin{frame}[label={sec:org1c1dc11}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org553b779}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgc0994b3}]{Cómo se escribe}
...
\begin{frame}[label={sec:org5b2d540}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\begin{frame}[label={sec:orgac301ab}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org6ac7071}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:orgba368e0}]{Correlaciones \(F_{D}\) y \(K_{T}\): Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orgcb0d199}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
...
\begin{frame}[label={sec:orga8a9697}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:org7688cda}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orga392058}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:org5f4bff5}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:org7220396}]{Cálculo para estática}
\begin{description}
...
\label{sec:org5a04504}
\subsection{Introducción}
\label{sec:org63e3335}

\begin{frame}[label={sec:org42d4196}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\label{sec:org8ee8323}
\begin{frame}[label={sec:org37b437b}]{Estaciones Meteorológicas: medida directa}
...
\begin{frame}[label={sec:org7919f3e}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org2db26ab}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\label{sec:org40cd254}

\begin{frame}[label={sec:org2348af2}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:org4790464}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:org286e637}]{Baseline Surface Radiation Network}
\begin{itemize}
...
\begin{frame}[label={sec:org0461287}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:orgabf7602}]{MAGRAMA-SIAR}
...
\begin{frame}[label={sec:orgec3c6ae}]{MAGRAMA-SIAR}
...
\begin{frame}[label={sec:org70f2856}]{AEMET}
...
\begin{frame}[label={sec:org49eba90}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:org4db13a7}

\begin{frame}[label={sec:org401662e}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
...
\begin{frame}[label={sec:org4430ae9}]{SSE-NASA}
...
\begin{frame}[label={sec:orgf6c73e2}]{EUMETSAT - SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org7e2f649}]{SAFs}
\begin{itemize}
...
\begin{frame}[label={sec:org4148d4a}]{SAFs: Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:org0efd4d7}]{ADRASE - CIEMAT}
...
\begin{frame}[label={sec:org847e346}]{Coherencia espacial}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:org362a16b}]{Coherencia estadística}
...
\begin{frame}[label={sec:org62d0694}]{Método de Chauvenet}
\begin{itemize}
...
\begin{frame}[label={sec:org7a8e6a8}]{Otros estimadores: t y d}
\begin{itemize}
...
\begin{frame}[label={sec:org7c28b66}]{Correlación}
...
\begin{frame}[label={sec:org70f03f1}]{Diagramas de Taylor}
\begin{itemize}
