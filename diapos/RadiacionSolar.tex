...
\begin{frame}[label={sec:org1552155}]{Inclinación de Eje Horizontal N-S}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org3ab77ca}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org6037649}]{Cómo se escribe}
...
\begin{frame}[label={sec:org0955e90}]{Correlaciones \(F_{D}\) y \(K_{T}\): Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orgfde726b}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
