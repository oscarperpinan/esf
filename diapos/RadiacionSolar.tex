...
\label{sec:org5b9a6fd}

\begin{frame}[label={sec:orge41fe27}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfd868db}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org4153327}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org65cb9db}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgd359e8d}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:orgbe13a5a}
\subsection{Movimiento Sol-Tierra}
\label{sec:org4ce69c8}

\begin{frame}[label={sec:org3d1acd4}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:orgf39cf2b}]{Movimiento terrestre}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlanoEcliptica.pdf}
\end{center}
...
\label{sec:orgf6c6ade}

\begin{frame}[label={sec:org5a40464},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:orgd9516b5}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgbb1702f}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org7be5d69}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org74565d6}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgef41338},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge84ecea}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org84a9351},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org407cbfb},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org7263993}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org07755b8}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:org20315df}
\begin{frame}[label={sec:org79aef1a}]{Hora solar}
...
\begin{frame}[label={sec:org6c45813}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:orgb5a174b}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgd9107e4}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:orgc5ec6e5}]{Ejemplo de cálculo}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org7c1a587}]{Solución}
\[\omega=15\cdot(\mathrm{TO}-\mathrm{AO}-12)+\Delta\lambda+\frac{\mathrm{EoT}}{4}\]
...
\begin{frame}[label={sec:org32a2513}]{}
\begin{center}
...
\label{sec:orgf08f682}

\subsection{Radiación Extra-atmosférica}
\label{sec:org3fbd0d8}

\begin{frame}[label={sec:orgd54c79f}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:orgda6d345}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgee0b85f}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org1d4d555}]{Días promedio}
\begin{itemize}
...
\label{sec:org39b71c4}
\begin{frame}[label={sec:orge685ff5}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4d3d2ba}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org8f101f9}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:orge65f294}]{Cómo se escribe}
...
\begin{frame}[label={sec:org41a7a38}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:org60afc61}

\begin{frame}[label={sec:orgf4a8644}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org399b7bd}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orge318971}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:orgb088831}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:org27a358b},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:org840a972}]{Correlaciones \(F_{D}\) y \(K_{T}\)}
...
\begin{frame}[label={sec:org2fefcd4},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:org27176b1}]{Ejemplo}
\begin{description}
...
\label{sec:org7b16fec}
\subsection{Introducción}
\label{sec:org1766fdc}
\begin{frame}[label={sec:orga60efd9}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9572701}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:org31c4b78}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:orgdf45462}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgf854b45}]{Resumen}
...
\label{sec:org34b3869}
\begin{frame}[label={sec:org1cf08d2}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org397cbb1}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org4c22a86}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org1b312f2}]{Fuentes de Datos}
...
\label{sec:org8a148d9}
\begin{frame}[label={sec:orgdfad96a}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:orgfa7933b}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org21d8440}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:orgff8a02b}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org8a690c4}]{Exactitud y Precisión}
\begin{center}
...
\begin{frame}[label={sec:org9afab34}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:orgfcad505}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:org7e129f1}

\subsection{Introducción}
\label{sec:orgbf67788}

\begin{frame}[label={sec:orgffd5d97}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org8a2c1c5}]{Definiciones}
\begin{itemize}
...
\label{sec:org615657a}
\begin{frame}[label={sec:org7be77ee}]{Sistema Estático}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1b64837}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org64999d2}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org1a26782}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org96fa0eb}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:orgfa15dc9}
\begin{frame}[label={sec:org16fb50a}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org936540b}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgb24dfb1}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org641af82}]{Ecuaciones}
\[
...
\label{sec:org76ae68f}

\begin{frame}[label={sec:org4446046}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org50134cd}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org59dede6}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org85bf000}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:orgf4c3d6f}]{Irradiancia Difusa Isotrópica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:org57ead58}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:orge21818f}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\label{sec:orgd2fbfbe}
\begin{frame}[label={sec:org3648761},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org3c04fa8}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgd2822a8},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:org8b6e767}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org91982e7}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org468748a},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org4dfe1fb}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org554eb58}

\begin{frame}[label={sec:org32eb355}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge50574d}]{Radiación directa}
...
\begin{frame}[label={sec:orgecf1487}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:org34367b1}]{Pérdidas anuales}
\begin{center}
...
\label{sec:org909a5b1}

\begin{frame}[label={sec:orgb1917fe}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org5e3a651}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orga3086c2}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org3b86fe1}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:org93acb3f}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org9266d17}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:org5e9c95a}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org74fdb07}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:orgb7b4756}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
