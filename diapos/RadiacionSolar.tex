...
\begin{frame}[label=sec-6-5-3]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label=sec-6-5-4]{MAGRAMA-SIAR}
...
\begin{frame}[label=sec-6-6-4]{SAFs: Radiación}
\begin{itemize}
...
\begin{frame}[label=sec-6-6-5]{ADRASE - CIEMAT}
