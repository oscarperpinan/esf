...
\label{sec:orgf576069}

\begin{frame}[label={sec:orgf1bce69}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orge18ae45}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org262c8b2}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org9afd5ca}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org31b9827}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:orgaeeed44}
\subsection{Movimiento Sol-Tierra}
\label{sec:orgce913db}

\begin{frame}[label={sec:org7e5040c}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org5d22d17}]{Movimiento terrestre}
\begin{columns}
...
\label{sec:orga419f5b}

\begin{frame}[label={sec:org037b524},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:org9d91ead}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:org1f44839}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgd76b056}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org8e22e5c}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb30ce99},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf89cdf5}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org237cf03},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org211396a},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org5e29c2e}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org99ce6e4}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orga721fff}
\begin{frame}[label={sec:orgc7af6df}]{Hora solar}
...
\begin{frame}[label={sec:orga67d57c}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org63280e1}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgad27440}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:org7af0f77}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:orgfd4ef54}]{}
\begin{center}
...
\label{sec:org13392fa}

\subsection{Radiación Extra-atmosférica}
\label{sec:orgcbd5a82}

\begin{frame}[label={sec:org20891bf}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:orgd82c3c0}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org20e1c1c}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org321fb47}]{Días promedio}
\begin{itemize}
...
\begin{frame}[label={sec:org2cf9791}]{Ejemplo de cálculo}
...
\label{sec:org8a7123f}
\begin{frame}[label={sec:org18b2f2b}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org74463f7}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2bc017}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org51e6a82}]{Cómo se escribe}
...
\begin{frame}[label={sec:orgd779ad5}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:org6b07094}

\begin{frame}[label={sec:org5096c19}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org19568bb}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgdcf8094}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org39c7809}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:orgf0d863c},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:org7894317}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:org391e906},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:orgb7534fc}]{Ejemplo de cálculo}
...
\label{sec:org8d52f9a}
\subsection{Introducción}
\label{sec:orgac38fb8}
\begin{frame}[label={sec:orgb2d574d}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgef81377}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:org25566e5}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org69d4c80}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orga9a78e9}]{Resumen}
...
\label{sec:orgcbd300e}
\begin{frame}[label={sec:orgd1a0700}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org28f12e5}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org9f1449f}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org47c390b}]{Fuentes de Datos}
...
\label{sec:orgb0e59e7}
\begin{frame}[label={sec:orgcd3b394}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2aa409}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org7503fa7}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:orgbedbc0c}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org69cf586}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org0f7bd65}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:org53cdaa5}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:orgbc1fe75}

\subsection{Introducción}
\label{sec:org6453cf0}

\begin{frame}[label={sec:org6bd51cf}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org96ac8f6}]{Definiciones}
\begin{itemize}
...
\label{sec:org4478fba}
\begin{frame}[label={sec:org7ec512a}]{Sistema Estático}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6136c51}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org730f596}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgbe91d0c}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4e75de8}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org886c5e8}
\begin{frame}[label={sec:orgf4b373a},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org2d1a22e}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org4e0444b},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:orgef98f55}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org0dc0ad5}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org80ea711},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{center}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgfc27974}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org5500b49}
\begin{frame}[label={sec:org66f43b9}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge78ad5d}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org2e5d0c7}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org0fa5f73}]{Ecuaciones}
\[
...
\begin{frame}[label={sec:orgff62524}]{Ejemplo de cálculo}
...
\label{sec:org4d2dde5}

\begin{frame}[label={sec:org6f7b4d7}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc04b20a}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgd2c93d1}]{Irradiancia Directa}
...
\begin{frame}[label={sec:orgefdc586}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:orgbf939c5}]{Irradiancia Difusa Isotrópica}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:org96770c6}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:orgdf16018}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\begin{frame}[label={sec:org16c7f43}]{Ejemplo de cálculo}
...
\label{sec:orgc55c9b6}

\begin{frame}[label={sec:org82a8e7f}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2bab5ae}]{Radiación directa}
...
\begin{frame}[label={sec:orgc200099}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgef8a45f}]{Pérdidas anuales}
\begin{center}
...
\label{sec:org9652b1d}

\begin{frame}[label={sec:org1ebb5f2}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:orgbf32ffe}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org26963d7}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org344836a}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:org37ae73b}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org420cdd6}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:org845bc88}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org20fb737}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:org6617079}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{/home/oscar/github/esf/figs/Kahoot_Logo.png}
\end{center}
