...
\label{sec:org5ed9b68}

\begin{frame}[label={sec:org6de6682}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org8682934}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orgbf75cd7}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org9ce8758}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org2b56063}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:orgb33aee5}
\subsection{Movimiento Sol-Tierra}
\label{sec:org77eb5ab}

\begin{frame}[label={sec:orga47bb16}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:orgd039871}]{Movimiento terrestre}
\begin{columns}
...
\label{sec:orga17539e}

\begin{frame}[label={sec:org3872c6f},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:org433d1c9}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgc57448b}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org51fd403}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org168b44e}]{Duración del día}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org798c8de},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org0f1bc45}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org356d7e6},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:org2b2e9e3},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org7e14822}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:orgcc2d578}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orge4af1f1}
\begin{frame}[label={sec:org6c4faa9}]{Hora solar}
...
\begin{frame}[label={sec:orga2f5890}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org000e806}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgd1d55e1}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:orgcfffbce}]{Ejemplo de cálculo}
...
\label{sec:org9b66629}

\subsection{Radiación Extra-atmosférica}
\label{sec:org3ae2f86}

\begin{frame}[label={sec:org76eab0c}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:orga13d4fc}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd981220}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org054e8ea}]{Días promedio}
\begin{itemize}
...
\begin{frame}[label={sec:org79f2c02}]{Ejemplo de cálculo}
...
\label{sec:orgc335a95}
\begin{frame}[label={sec:orgc9365c7}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org98d2c20}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgf9a0a12}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgb7a8e4f}]{Cómo se escribe}
...
\begin{frame}[label={sec:org073d9c7}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:org42b3a20}

\begin{frame}[label={sec:org67d47cb}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2dbf784}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:org202bcd7}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org846bbd4}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:orgba90136},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:orge2eaac7}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:orgccd5e55},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:org9756a80}]{Ejemplo de cálculo}
...
\label{sec:org14f0be9}
\subsection{Introducción}
\label{sec:orga8a5d2f}
\begin{frame}[label={sec:orga436ae0}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga857490}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:orgd40d7c8}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org547d2bc}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgdd19b74}]{Resumen}
...
\label{sec:org379c7d9}
\begin{frame}[label={sec:org9ceabff}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:org513da2d}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:orge20bc4e}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:orgb4a6753}]{Fuentes de Datos}
...
\label{sec:orgb68b2b4}
\begin{frame}[label={sec:orgb3cad4d}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org8f48100}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org2bc3b5f}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org1545da7}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgce05bc4}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org02716a8}]{Métricas}
\begin{itemize}
...
\label{sec:org7d7b8dd}

\subsection{Introducción}
\label{sec:org0d0fbc8}

\begin{frame}[label={sec:orga8818a8}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orgae41d22}]{Definiciones}
\begin{itemize}
...
\label{sec:org17c8784}
\begin{frame}[label={sec:org6db4014}]{Sistema Estático}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbf53d00}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org94ff2f7}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgad9e0e3}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1b59054}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org9d2d6ca}
\begin{frame}[label={sec:orgcae3199},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org841d9d4}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org22ba276},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:org44c95ae}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org69c49ac}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org9e70e14},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf55ce1d}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org1c8e932}
\begin{frame}[label={sec:org5b2d6cd}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf4f0084}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgc2433d5}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:org62c5999}]{Ecuaciones}
\[
...
\begin{frame}[label={sec:orgd2f377f}]{Ejemplo de cálculo}
...
\label{sec:org8f0d52a}

\begin{frame}[label={sec:org7a91d12}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org257d22a}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org30dd2d7}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org7197748}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:orge36d544}]{Irradiancia Difusa Isotrópica}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org52e3d13}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:orgcab6ea1}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[height=0.55\textheight]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc7fcb53}]{Valores diarios}
...
\begin{frame}[label={sec:orgee87893}]{Ejemplo de cálculo}
...
\label{sec:orgdac2a01}

\begin{frame}[label={sec:org4c09a88}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5741513}]{Radiación directa}
...
\begin{frame}[label={sec:org7ce9172}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgfc224c1}]{Pérdidas anuales}
\begin{center}
...
\label{sec:org512de61}

\begin{frame}[label={sec:org327c789}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:orgd577060}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org3ac00a5}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org44563f5}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orgd6f2d36}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orgf125072}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:orgee47081}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8f6f5c0}]{Comparación entre Sistemas}
\begin{center}
