...
\label{sec:org2eaca1a}

\begin{frame}[label={sec:org79c912c}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org8e6f0c0}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orge1d83b9}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orge0a6966}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orgb9575d8}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org19a53e2}
\subsection{Movimiento Sol-Tierra}
\label{sec:org8757b15}

\begin{frame}[label={sec:org1204919}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org696f71e}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org09865c4}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org913126e}]{Duración del día}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1c0d232},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9f7fd05}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:orgcbd3bd1},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:orgc1bc505},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:org147e75c}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org893c7a1}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:orgc7b164b}
\begin{frame}[label={sec:org038bce0}]{Hora solar}
...
\begin{frame}[label={sec:org69c6c58}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org447974d}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org9c25e60}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orga85a229}]{Resumen}
...
\label{sec:org739a0fb}
\begin{frame}[label={sec:orgae7af11}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:orge0acabd}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org1813d32}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org5742984}]{Fuentes de Datos}
...
\label{sec:orgf479a2b}
\begin{frame}[label={sec:orge6ae752}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:org4374f0f}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:org1f672ca}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org547b97d}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org4e2fb56}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org14e3423}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\label{sec:org9af27ea}

\begin{frame}[label={sec:orgae3f12f}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:org4725b65}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org3ffe020}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:orgc139f2d}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:orgd206da0}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org670dade}]{Comparación Eje Horizontal - Estática}
\begin{center}
