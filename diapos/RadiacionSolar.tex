...
\label{sec:org615a57f}

\begin{frame}[label={sec:org43f8f8a}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgf198315}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org8c95798}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org696fb09}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orga782923}]{Del plano horizontal al plano inclinado}
\begin{center}
...
\label{sec:org9bc2557}
\subsection{Movimiento Sol-Tierra}
\label{sec:org400e6cd}

\begin{frame}[label={sec:org2564752}]{Movimiento terrestre}
\begin{center}
...
\begin{frame}[label={sec:org20d384e}]{Movimiento terrestre}
\begin{columns}
...
\label{sec:org687fca2}

\begin{frame}[label={sec:org2b983df},plain]{Ejes terrestres}
\begin{columns}
...
\begin{frame}[label={sec:org1e9d8f1}]{Declinación}
\begin{center}
...
\begin{frame}[label={sec:orgfb15132}]{Estaciones}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org12baa4b}]{Hora Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org4d63b38}]{Duración del día}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/DuracionDia.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org52e515a},plain]{Ejes locales}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7a80919}]{Relación entre sistemas de coordenadas}
\begin{center}
...
\begin{frame}[label={sec:org3bd45de},plain]{Cenit Solar}
\[
...
\begin{frame}[label={sec:orgf689e21},plain]{Azimut solar}
\[
...
\begin{frame}[label={sec:orgf829564}]{Trayectoria Solar (\(60\degree N\))}
\begin{center}
...
\begin{frame}[label={sec:org58f059b}]{Trayectoria Solar (\(40\degree S\))}
\begin{center}
...
\label{sec:org1c0e995}
\begin{frame}[label={sec:orgb0d0603}]{Hora solar}
...
\begin{frame}[label={sec:org6048502}]{Hora oficial}
\begin{itemize}
...
\begin{frame}[label={sec:org1c037ca}]{Tiempo solar medio}
\begin{itemize}
...
\begin{frame}[label={sec:orgecbf288}]{Ecuación del Tiempo}
\[
...
\begin{frame}[label={sec:org631e6d2}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:org84ea9ec}]{}
\begin{center}
...
\label{sec:orgc0be062}

\subsection{Radiación Extra-atmosférica}
\label{sec:org3823f25}

\begin{frame}[label={sec:orge7b87e5}]{Irradiancia e Irradiación}
\begin{description}
...
\begin{frame}[label={sec:org344c964}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org361f864}]{Ecuaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orge7129c7}]{Días promedio}
\begin{itemize}
...
\begin{frame}[label={sec:orgcdbfcfb}]{Ejemplo de cálculo}
...
\label{sec:org5ac816b}
\begin{frame}[label={sec:orgd05c961}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_G0.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgea85532}]{Interacción de la radiación con la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgd6a74cb}]{Componentes de la radiación solar}
\begin{itemize}
...
\begin{frame}[label={sec:org371fde4}]{Cómo se escribe}
...
\begin{frame}[label={sec:org6603ac6}]{Cómo se escribe}
\begin{block}{Forma, tiempo, lugar}
...
\label{sec:orgff7d6ec}

\begin{frame}[label={sec:orgb726739}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_componentes.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org519d51f}]{Caracterización de la atmósfera}
\begin{itemize}
...
\begin{frame}[label={sec:orgaed47a1}]{Índice de claridad}
\begin{description}
...
\begin{frame}[label={sec:org128b3ce}]{Estimación de Directa y Difusa}
\begin{itemize}
...
\begin{frame}[label={sec:orgd80cbcd},plain]{Medias mensuales: Ecuación de Page}
\begin{center}
...
\begin{frame}[label={sec:org0002a98}]{Ejemplo de cálculo}
...
\begin{frame}[label={sec:org7527123},plain]{Valores Diarios: Collares-Pereira y Rabl}
\begin{center}
...
\begin{frame}[label={sec:orgc248e16}]{Ejemplo de cálculo}
...
\label{sec:orgbe12416}
\subsection{Introducción}
\label{sec:org518c1e3}
\begin{frame}[label={sec:org879f08f}]{Variabilidad Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgde13ede}]{Estimaciones a Largo Plazo}
\begin{itemize}
...
\begin{frame}[label={sec:org60a4f4b}]{Variabilidad Temporal}
\begin{center}
...
\begin{frame}[label={sec:org76eb4fa}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org78db9e0}]{Resumen}
...
\label{sec:orgd504e91}
\begin{frame}[label={sec:org2bf1329}]{Estaciones Meteorológicas}
\begin{itemize}
...
\begin{frame}[label={sec:orgd4490d9}]{Imágenes de Satelite}
\begin{itemize}
...
\begin{frame}[label={sec:org31f68e7}]{Métodos Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org7f10c76}]{Fuentes de Datos}
...
\label{sec:org42e475e}
\begin{frame}[label={sec:org29bcb1b}]{Introducción}
\begin{itemize}
...
\begin{frame}[label={sec:orgc81e117}]{Límites Físicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgf8a3739}]{Coherencia Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org7a94007}]{Análisis Estadístico de las Desviaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org9452c57}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org0cde045}]{Métricas}
\begin{itemize}
...
\]
\end{frame}
\begin{frame}[label={sec:orgaf7bc48}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Kahoot_Logo.png}
\end{center}
...
\label{sec:org3a14fc8}

\subsection{Introducción}
\label{sec:orgcc10fdb}

\begin{frame}[label={sec:org32acd33}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org9e49ad7}]{Definiciones}
\begin{itemize}
...
\label{sec:orga3ae669}
\begin{frame}[label={sec:org3662034}]{Sistema Estático}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org65bccc2}]{Sistemas con seguimiento}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org44e017d}]{Algunos tipos de seguimiento solar}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org9406eee}]{Sistema de Seguimiento(1 eje, horizontal N-S)}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/SeguidorEjeHorizontal.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0f8e715}]{Sistema de Seguimiento (2x ejes)}
\begin{center}
...
\label{sec:org6b9d826}
\begin{frame}[label={sec:org3e5aeb8},plain]{Ángulo de Incidencia Sistema Estático}
\begin{itemize}
\item Si \(\alpha=0\)
\end{itemize}
\[
...
\begin{frame}[label={sec:org15e7d19}]{Sistema Estático: Ángulo de Incidencia}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgc915ae9},plain]{Ángulo de Incidencia Seguidor 1x NS}
...
\begin{frame}[label={sec:orgf0f8691}]{Ángulo de Inclinación Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org5ae42d8}]{Ángulo de Incidencia Seguidor 1x NS}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:org0afaeae},plain]{Ángulo de Incidencia Seguidor 2x}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga40e1ce}]{Inclinación Seguidor 2x}
\begin{itemize}
\item \(40\degree N\)
\end{itemize}
\begin{center}
...
\label{sec:org4236366}
\begin{frame}[label={sec:org51771ec}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_perfil.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org54a0ebb}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org601aa76}]{Perfil}
\[D(0) = r_D \cdot D_{d}(0)\]
...
\begin{frame}[label={sec:orgb587fc5}]{Ecuaciones}
\[
...
\begin{frame}[label={sec:org46bd9ae}]{Ejemplo de cálculo}
...
\label{sec:org781da56}

\begin{frame}[label={sec:org5686a9f}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_inclinada.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org43280bd}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org4a8760b}]{Irradiancia Directa}
...
\begin{frame}[label={sec:org0d0fee6}]{Irradiancia Difusa}
\begin{center}
...
\begin{frame}[label={sec:org70e0e9a}]{Irradiancia Difusa Isotrópica}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org77df284}]{Irradiancia Difusa Anisotrópica}
...
\begin{frame}[label={sec:org9eb131a}]{Irradiancia de Albedo}
\begin{center}
\includegraphics[height=0.55\textheight]{../figs/AnguloVisionCielo.pdf}
\end{center}
...
\begin{frame}[label={sec:org6e7e458}]{Valores diarios}
...
\begin{frame}[label={sec:orgd093648}]{Ejemplo de cálculo}
...
\label{sec:org8e46bca}

\begin{frame}[label={sec:org75559e4}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/ProcedimientoCalculoRadiacionInclinada_efectiva.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org25ff0ae}]{Radiación directa}
...
\begin{frame}[label={sec:org8f48722}]{Difusa y Albedo}
\begin{align*}
...
\end{align*}
\end{frame}
\begin{frame}[label={sec:orgd07ec4c}]{Pérdidas anuales}
\begin{center}
...
\label{sec:orge1047b0}

\begin{frame}[label={sec:org2965347}]{Radiación en Sistema estático}
\begin{center}
...
\begin{frame}[label={sec:orgfc533eb}]{Radiación en Seguimiento Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org01bf2f2}]{Radiación en Seguimiento Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:orgbfd29e0}]{Comparación Doble Eje-Estática}
\begin{center}
...
\begin{frame}[label={sec:org105c74d}]{Comparación Doble Eje - Horizontal}
\begin{center}
...
\begin{frame}[label={sec:orge81b104}]{Comparación Eje Horizontal - Estática}
\begin{center}
...
\begin{frame}[label={sec:org2cfdc3c}]{Comparación entre Sistemas}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/compSystems.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgca5c975}]{Comparación entre Sistemas}
\begin{center}
...
\begin{frame}[label={sec:orge17a92d}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Kahoot_Logo.png}
\end{center}
