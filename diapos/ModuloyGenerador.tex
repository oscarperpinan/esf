...
\begin{frame}[label={sec:org5c8955f}]{Estructura de un módulo fotovoltaico}
\begin{center}
...
\begin{frame}[label={sec:org7b3a3e2}]{El vidrio frontal}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org15a70fe}]{EVA}
\begin{itemize}
...
\begin{frame}[label={sec:orgbdb9e83}]{Configuración eléctrica}
\begin{itemize}
...
\begin{frame}[label={sec:orgb663cef}]{Norma Internacional IEC 61215}
\begin{itemize}
...
\begin{frame}[label={sec:org8c4287e}]{TONC}
\begin{itemize}
...
\label{sec:org5e0e9f2}

\subsection{Definición}
\label{sec:orge0be7bf}

\begin{frame}[label={sec:org61664ef}]{Generador Fotovoltaico}
\begin{columns}
...
\begin{frame}[label={sec:org3c8f600}]{Ramas y series}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}
