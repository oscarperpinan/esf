...
\label{sec:org04ba4b8}

\begin{frame}[label={sec:org08274b1}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org6fc349f}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf242e3}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orgc5b0011}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org72b7a82}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org16dcda8}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:org93367be}]{Variabilidad Temporal}
\[
...
\begin{frame}[label={sec:orgacb26a5}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org8b5ca21}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orgcd31412}]{Estimación a partir de Medidas}
\begin{itemize}
...
\begin{frame}[label={sec:org8dd0f9f}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:orgbfcd5ee}

\subsection{Fundamentos}
\label{sec:org75b794b}
\begin{frame}[label={sec:org917ea41}]{Medida directa}
...
\begin{frame}[label={sec:org34c243a}]{Medida directa}
...
\begin{frame}[label={sec:orgc5ec69e}]{Modelos empíricos}
...
\begin{frame}[label={sec:org1cedba4}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:orga9aa6d2}

\begin{frame}[label={sec:orgee4bb6d}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:orgf941bcf}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:orgcc7e866}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:org905732b}]{SIAR}
...
\begin{frame}[label={sec:org7abdd19}]{SIAR}
...
\begin{frame}[label={sec:orgcce1c8f}]{AEMET}
...
\begin{frame}[label={sec:org068bd7a}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:org0a03808}

\subsection{Fundamentos}
\label{sec:org7951ca9}

\begin{frame}[label={sec:orgf0f7065}]{Fundamentos}
\begin{itemize}
...
\begin{frame}[label={sec:org69131c5}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8040f0}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:org2f46db8}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\begin{frame}[label={sec:org7a1de01}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org26ba26c}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\subsection{Fuentes de Datos}
\label{sec:org5233477}

\begin{frame}[label={sec:org77f3d73}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
...
\begin{frame}[label={sec:org0ffb93e}]{SSE-NASA}
...
\begin{frame}[label={sec:orgc96e9b9}]{EUMETSAT - SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org47eaacf}]{SAFs}
\begin{itemize}
...
\begin{frame}[label={sec:org4a7c653}]{SAFs: Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:org4fbc33b}]{ADRASE - CIEMAT}
...
\label{sec:orgb029f7d}

\begin{frame}[label={sec:org9eb006a}]{Interpolación Espacial}
...
\begin{frame}[label={sec:orgc4f4f23}]{Corrección por topografía}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orgbc33eb2},fragile]{PVGIS - \texttt{r.sun}}
...
\label{sec:org7a768e5}
\begin{frame}[label={sec:orgd2e1c06}]{Introducción}
...
\label{sec:org658b21b}
\begin{frame}[label={sec:orgfd93e9e}]{Irradiación Diaria}
\begin{itemize}
...
\begin{frame}[label={sec:org31d958e}]{Irradiancia (intradiaria)}
\begin{itemize}
...
\label{sec:orge949b5e}

\begin{frame}[label={sec:org05b5390}]{Tests de variabilidad}
...
\label{sec:orgb65163c}
\begin{frame}[label={sec:org01833ec}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org8ca5cba}]{Procedimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org8fccc4e}]{Métricas para diferencias}
\begin{itemize}
