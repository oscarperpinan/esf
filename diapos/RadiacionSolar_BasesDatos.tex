...
\label{sec:org11ab20c}

\begin{frame}[label={sec:orgc5321bc}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org667e636}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org4adbf18}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:orga97907a}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:orga5c2d1e}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:orgf7d38fe}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:org7f7a6c6}]{Variabilidad Temporal}
\[
...
\begin{frame}[label={sec:org83a05b2}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org3e4aa3d}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org641193f}]{Estimación a partir de Medidas}
\begin{itemize}
...
\begin{frame}[label={sec:org86439d6}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:orga8b4bbe}

\subsection{Fundamentos}
\label{sec:org77fcab4}
\begin{frame}[label={sec:orga3d4bc5}]{Medida directa}
...
\begin{frame}[label={sec:orgb89ca53}]{Medida directa}
...
\begin{frame}[label={sec:org6f14fca}]{Modelos empíricos}
...
\begin{frame}[label={sec:org18112fa}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:org6cb66f2}

\begin{frame}[label={sec:orgd8fd6c8}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:org34e27d3}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:org3b435cd}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:orgc06e0d7}]{SIAR}
...
\begin{frame}[label={sec:orgca604fc}]{SIAR}
...
\begin{frame}[label={sec:orgc4f5513}]{AEMET}
...
\begin{frame}[label={sec:org9928da7}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:org21d174b}

\subsection{Fundamentos}
\label{sec:orgd21043a}

\begin{frame}[label={sec:orgd17bd01}]{Fundamentos}
\begin{itemize}
...
\begin{frame}[label={sec:org4f4b97f}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\begin{frame}[label={sec:org651c5ec}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:org482070b}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\begin{frame}[label={sec:orge94b0d0}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org7e0b795}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\subsection{Fuentes de Datos}
\label{sec:orga19bbab}

\begin{frame}[label={sec:org7126fc0}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
...
\begin{frame}[label={sec:orgfd8a351}]{SSE-NASA}
...
\begin{frame}[label={sec:orgf39a39c}]{EUMETSAT - SAF}
\begin{itemize}
