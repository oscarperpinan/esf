...
\label{sec:orgdd426b2}

\begin{frame}[label={sec:org8f341e9}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgff4813b}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org2e10d7b}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org5bde374}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org7f8b2ca}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org21a3380}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:org0d0c4e1}]{Variabilidad Temporal}
\[
...
\begin{frame}[label={sec:org1203799}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgfeb6003}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org587134e}]{Estimación a partir de Medidas}
\begin{itemize}
...
\begin{frame}[label={sec:org14e9dce}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:orga5d1c2d}

\subsection{Fundamentos}
\label{sec:orge90e0f5}
\begin{frame}[label={sec:org5ada933}]{Medida directa}
...
\begin{frame}[label={sec:orge4b3c54}]{Medida directa}
...
\begin{frame}[label={sec:org56014e5}]{Modelos empíricos}
...
\begin{frame}[label={sec:org66e20b5}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:org86dd9e7}

\begin{frame}[label={sec:org0c0970a}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:org378c55b}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:org4bc9c3d}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:org6a6a666}]{SIAR}
...
\begin{frame}[label={sec:orge4d0896}]{SIAR}
...
\begin{frame}[label={sec:org3362026}]{AEMET}
...
\begin{frame}[label={sec:orgf680df7}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:org48019f5}

\subsection{Fundamentos}
\label{sec:org7da5cb7}

\begin{frame}[label={sec:org4a80fca}]{Fundamentos}
\begin{itemize}
...
\begin{frame}[label={sec:org985d94c}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\begin{frame}[label={sec:orgd18f6a1}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:orgaf31bf0}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\begin{frame}[label={sec:org51b16a7}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:orgef64ebf}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\subsection{Fuentes de Datos}
\label{sec:orgb338cae}

\begin{frame}[label={sec:orgada41af}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
...
\begin{frame}[label={sec:org7b19d5d}]{SSE-NASA}
...
\begin{frame}[label={sec:org691b4c8}]{EUMETSAT - SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org14d9195}]{ADRASE - CIEMAT}
...
\label{sec:org5967fba}

\begin{frame}[label={sec:org0d6fe75}]{Interpolación Espacial}
