...
\label{sec:orgf59db25}

\begin{frame}[label={sec:org92c7559}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0248613}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org54e267d}]{Ángulo de Inclinación}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org592f1eb}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1ed066d}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7e5094a}]{Variabilidad Temporal}
...
\nocite{Perpinan2009}
\end{frame}
\begin{frame}[label={sec:org9ec1140}]{Variabilidad Temporal}
\[
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9ea5115}]{Variabilidad Espacial}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org6b2909c}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgafafe0c}]{Estimación a partir de Medidas}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfc47237}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:orgf1d009a}

\subsection{Fundamentos}
\label{sec:orgc896739}
\begin{frame}[label={sec:orgee8ef95}]{Medida directa}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcce2f85}]{Medida directa}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb51592e}]{Modelos empíricos}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbca7731}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:org4eb243c}

\begin{frame}[label={sec:orgd959d49}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
\begin{frame}[label={sec:orga9c814e}]{Baseline Surface Radiation Network}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1a96468}]{Measurement and Instrumentation Data Center NREL}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4e266ab}]{SIAR}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1da8f56}]{SIAR}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8ba5cd6}]{AEMET}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbc2f349}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:orgb62d51b}

\subsection{Fundamentos}
\label{sec:org1dd95d2}

\begin{frame}[label={sec:org1104b50}]{Fundamentos}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1c99b9f}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org7a31364}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7ca1bf2}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd8f144e}]{Procedimientos: CM SAF}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org5ac8af8}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\end{frame}
\subsection{Fuentes de Datos}
\label{sec:org12ffa83}

\begin{frame}[label={sec:orgd08bb93}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
\begin{frame}[label={sec:org4f409a1}]{SSE-NASA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1e4eb7e}]{EUMETSAT - SAF}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc7e4c73}]{SAFs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0052685}]{SAFs: Radiación}
\begin{itemize}
...
\label{sec:orgb2034ee}

\begin{frame}[label={sec:org273661b}]{Interpolación Espacial}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga05aaa2}]{Corrección por topografía}
\begin{center}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org884d5d5},fragile]{PVGIS - \texttt{r.sun}}
...
\label{sec:org21c92c1}
\begin{frame}[label={sec:org424d148}]{Introducción}
...
\label{sec:orgff99d10}
\begin{frame}[label={sec:org572b6a8}]{Irradiación Diaria}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org23c9e4a}]{Irradiancia (intradiaria)}
\begin{itemize}
...
\label{sec:org8ca257a}

\begin{frame}[label={sec:orgfdb2c27}]{Tests de variabilidad}
...
\label{sec:org5fb7cc1}
\begin{frame}[label={sec:org82b6a40}]{Planteamiento}
\begin{itemize}
...
\nocite{Journee.Bertrand2011}
\end{frame}
\begin{frame}[label={sec:org39f56c0}]{Procedimiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org962a1d0}]{Métricas para diferencias}
\begin{itemize}
