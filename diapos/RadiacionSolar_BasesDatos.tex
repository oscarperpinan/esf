...
\label{sec:orgb649b77}

\begin{frame}[label={sec:org726dc6f}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgf39d259}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:orgc614cf5}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org0e27f41}]{Bases de Datos de Radiación Solar}
\begin{itemize}
...
\begin{frame}[label={sec:org1331d7f}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org77ab351}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:orge513594}]{Variabilidad Temporal}
\[
...
\begin{frame}[label={sec:orgfb43fb6}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org629756f}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org979708d}]{Estimación a partir de Medidas}
\begin{itemize}
...
\begin{frame}[label={sec:orgf85d684}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:org8ab74ee}

\subsection{Fundamentos}
\label{sec:org2637981}
\begin{frame}[label={sec:org3647bb4}]{Medida directa}
...
\begin{frame}[label={sec:orgd5d2839}]{Medida directa}
...
\begin{frame}[label={sec:orga49d744}]{Modelos empíricos}
...
\begin{frame}[label={sec:org8253ff9}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:org7480f43}

\begin{frame}[label={sec:orgb30b8a1}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:orgdb484dd}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:org863cfea}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:org0b4f9a0}]{SIAR}
...
\begin{frame}[label={sec:orgbd5787d}]{SIAR}
...
\begin{frame}[label={sec:org71f8e7c}]{AEMET}
...
\begin{frame}[label={sec:orgb5dec49}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:orga9d7cb4}

\subsection{Fundamentos}
\label{sec:org1803b75}

\begin{frame}[label={sec:org61748d9}]{Fundamentos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfd48f98}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\begin{frame}[label={sec:orgf273eed}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:org8679682}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\begin{frame}[label={sec:orgb10767e}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org052714a}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\subsection{Fuentes de Datos}
\label{sec:org9314820}

\begin{frame}[label={sec:org3b2e320}]{Wiki con recursos}
\begin{block}{}
\url{https://github.com/oscarperpinan/mds/wiki}
\end{block}
\end{frame}
...
\begin{frame}[label={sec:org6b07744}]{SSE-NASA}
...
\begin{frame}[label={sec:org4d657a6}]{EUMETSAT - SAF}
\begin{itemize}
...
\begin{frame}[label={sec:orgf4f6fa2}]{SAFs}
\begin{itemize}
...
\begin{frame}[label={sec:org7dfd4be}]{SAFs: Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:org16574fd}]{ADRASE - CIEMAT}
...
\label{sec:orgb265a3a}

\begin{frame}[label={sec:orgf3bc930}]{Interpolación Espacial}
...
\begin{frame}[label={sec:org3e7965e}]{Corrección por topografía}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org5cf42b2},fragile]{PVGIS - \texttt{r.sun}}
...
\label{sec:orgbae27f4}
\begin{frame}[label={sec:org7e03cd6}]{Introducción}
...
\label{sec:orgb745afa}
\begin{frame}[label={sec:org4138516}]{Irradiación Diaria}
\begin{itemize}
...
\begin{frame}[label={sec:org2e5cfe7}]{Irradiancia (intradiaria)}
\begin{itemize}
...
\label{sec:orgdffc78c}

\begin{frame}[label={sec:org465deb5}]{Tests de variabilidad}
...
\label{sec:orgde89147}
\begin{frame}[label={sec:orgd205464}]{Planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org6bc0404}]{Procedimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org7009434}]{Métricas para diferencias}
\begin{itemize}
