...
\begin{frame}[label={sec:org13dfc1f}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:org425391b}]{Variabilidad Espacial}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org77e8a38}]{Estimación a partir de Medidas}
\begin{itemize}
...
\begin{frame}[label={sec:org276b833}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:org6a0ab9f}

\subsection{Fundamentos}
\label{sec:org36caaab}
\begin{frame}[label={sec:org5d14090}]{Medida directa}
...
\begin{frame}[label={sec:org2a7df22}]{Medida directa}
...
\begin{frame}[label={sec:orgfbbd65f}]{Modelos empíricos}
...
\begin{frame}[label={sec:orgb12bcf1}]{Ejemplos de modelos empíricos}
\begin{itemize}
...
\label{sec:org1225414}

\begin{frame}[label={sec:org8326982}]{Wiki con recursos}
\begin{block}{}
...
\begin{frame}[label={sec:org83133b3}]{Baseline Surface Radiation Network}
...
\begin{frame}[label={sec:orgd26636a}]{Measurement and Instrumentation Data Center NREL}
...
\begin{frame}[label={sec:org47a41a2}]{SIAR}
...
\begin{frame}[label={sec:orgc553948}]{SIAR}
...
\begin{frame}[label={sec:org1500e99}]{AEMET}
...
\begin{frame}[label={sec:org609dee5}]{Redes de Comunidades Autónomas}
\begin{itemize}
...
\label{sec:org992f0c3}

\subsection{Fundamentos}
\label{sec:org3f2f9e3}

\begin{frame}[label={sec:org75ccac9}]{Fundamentos}
\begin{itemize}
...
\begin{frame}[label={sec:org69436b8}]{Satelites Geoestacionarios Europeos: Meteosat}
\begin{itemize}
...
\begin{frame}[label={sec:org58e3e0f}]{Procedimientos: Heliosat-2}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:orgc0c1367}]{Procedimientos: CM SAF}
\alert{Fundamento}
\begin{itemize}
...
\begin{frame}[label={sec:org119def2}]{Procedimientos: CM SAF}
\begin{itemize}
...
\begin{frame}[label={sec:orga249fd1}]{Procedimientos: LSA SAF}
\begin{itemize}
...
\begin{frame}[label={sec:org2333a3a}]{ADRASE - CIEMAT}
...
\label{sec:org862ec72}

\begin{frame}[label={sec:org2a29a0c}]{Interpolación Espacial}
