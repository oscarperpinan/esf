...
** Solar Hour Angle
- $w$, difference between the current instant and the noon or midday ($w = 0$).
  - (Hours) $-12, -11, -10, \dots, -1, \textbf{0}, 1, \dots, 10, 11, 12$
...
- Solar radiation incident on a horizontal plane at top of the atmosphere.
...
** Extraterrestrial Irradiation
- $B_{0d}(0)=-\frac{24}{\pi}B_{0}\epsilon_{0}\cdot(\omega_{s}\sin\phi\sin\delta+\cos\delta\cos\phi\sin\omega_{s})$
  - $\omega_{s}$ in radians
