...
\label{sec:orgb5860a7}

\subsection{Definición}
\label{sec:orgcc353d2}

\begin{frame}[label={sec:org1360eb8}]{Definición de un SFCR}
\begin{block}{}
...
\label{sec:org62ca59b}
\begin{frame}[label={sec:orgfc15e9e}]{Mecanismos de retribución}
\begin{itemize}
...
\begin{frame}[label={sec:org9185de7}]{Retribución con prima}
\begin{itemize}
...
\begin{frame}[label={sec:org82498e0}]{Balance neto}
\begin{itemize}
...
\label{sec:org9e78e8c}
\begin{frame}[label={sec:orgec2c33a}]{Características distintivas sobre suelo y en edificación}
\begin{itemize}
...
\begin{frame}[label={sec:org5693e37}]{SFCR sobre suelo}
\begin{itemize}
...
\begin{frame}[label={sec:orge002655}]{Estructuras sobre suelo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/EstructuraEstaticaSuelo.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6e714d7}]{SFCR sobre suelo: seguimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org9f5e324}]{SFCR sobre suelo: seguimiento}
\begin{itemize}
...
\begin{frame}[label={sec:orge4093f3}]{Seguidor de eje horizontal N-S}
\begin{center}
...
\begin{frame}[label={sec:orgcdc2ce5}]{Seguidor de doble eje}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SeguidorReocin.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb590880}]{SFCR en edificación}
\begin{itemize}
...
\begin{frame}[label={sec:org0b8739d}]{Integración arquitectónica}
\begin{itemize}
...
\begin{frame}[label={sec:orgf228bb5}]{SFCR en edificación: CTE-HE5}
\begin{itemize}
...
\begin{frame}[label={sec:org633e962}]{SFCR en edificación: CTE-HE5}
\begin{itemize}
...
\label{sec:orgd1f473e}

\begin{frame}[label={sec:org923335b}]{SFCR en Edificación: sistemas eléctricos}
\begin{itemize}
...
\begin{frame}[label={sec:org0ee3ee6}]{Separación entre comercialización y generación}
\begin{itemize}
...
\begin{frame}[label={sec:org480fe2e}]{Generación distribuida}
\begin{itemize}
...
\begin{frame}[label={sec:org5a1ee1c}]{El problema de la medida}
\begin{itemize}
...
\begin{frame}[label={sec:orgf425727}]{Ejemplo: suministro en MT}
\begin{itemize}
...
\begin{frame}[label={sec:orgc28c98e}]{Ejemplo: comunidades de vecinos}
\begin{itemize}
...
\label{sec:org73843dd}

\subsection{Conceptos Generales}
\label{sec:orgc7b9945}
\begin{frame}[label={sec:org4924b5f}]{Acoplamiento a la red}
\begin{block}{}
...
\begin{frame}[label={sec:orga6426f3}]{Definición}
\begin{itemize}
...
\label{sec:orgef7adb3}
\begin{frame}[label={sec:orgb2b9ae5}]{Tipos de inversores}
...
\begin{frame}[label={sec:org00b8d3a}]{Inversores de Rama}
\begin{itemize}
...
\begin{frame}[label={sec:org4f43712}]{Inversores Centrales}
\begin{itemize}
...
\label{sec:org1f9a302}
\begin{frame}[label={sec:orge7478f7}]{Potencia y ventana MPP}
\begin{itemize}
...
\begin{frame}[label={sec:org1c23bdd}]{Tensiones}
\begin{itemize}
...
\begin{frame}[label={sec:org7276242}]{Eficiencia y Rendimiento}
\begin{itemize}
...
\label{sec:org3f7a49b}
\begin{frame}[label={sec:org5994a1e}]{Entrada}
\begin{center}
...
\begin{frame}[label={sec:org72aabfb}]{Puente y salida}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/InversorPV.pdf}
\end{center}
...
\begin{frame}[label={sec:org7ed8eed}]{Control}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/InversorPV.pdf}
\end{center}
...
\label{sec:org301913a}
\begin{frame}[label={sec:org8dc736a}]{Modulación SPWM}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/SPWMMonofasico.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd1173a0}]{Busqueda del Punto de Máxima Potencia}
\begin{center}
...
\begin{frame}[label={sec:orgbf3f932}]{Busqueda del Punto de Máxima Potencia}
\begin{center}
\includegraphics[height=0.6\textheight]{../figs/CurvaIV_Ta20_G800.pdf}
\end{center}
...
\begin{frame}[label={sec:org92c151f}]{Transformador de salida}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/InversorPV.pdf}
\end{center}
...
\begin{frame}[label={sec:orgcfb4449}]{Opciones comerciales}
...
\begin{frame}[label={sec:orgb80b605}]{Normativa relativa al transformador}
...
\begin{frame}[label={sec:org75dd020}]{Normativa: Nota de Interpretación Tecnica}
\begin{itemize}
...
\label{sec:orgd85591a}
\begin{frame}[label={sec:org441f797}]{Definición del problema}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Isla.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge145cb9}]{Ecuaciones básicas}
...
\begin{frame}[label={sec:orgf060fc5}]{Casos posibles}
\begin{itemize}
...
\begin{frame}[label={sec:orgfaf4f0f}]{Ventana de no-detección}
...
\begin{frame}[label={sec:org3ff395f}]{Estudio experimental IEA-PVPS}
\begin{itemize}
...
\begin{frame}[label={sec:org4f5cad7}]{Estudio experimental IEA-PVPS}
\begin{itemize}
