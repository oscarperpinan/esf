...
\item Por ejemplo, toda la cornisa cantábrica está encuadrada en la zona I (radiación inferior a $\SI{3.8}{\kWh\per\meter\squared}$) mientras que
\end{itemize}
...
\begin{frame}[label=sec-1-3-13]{SFCR en edificación: CTE-HE5}
\begin{itemize}
