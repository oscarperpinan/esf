...
\label{sec:org6493eb2}

\begin{frame}[label={sec:org89a8615}]{Motor DC}
\begin{itemize}
...
\begin{frame}[label={sec:org1749cd9}]{Motor asíncrono o de inducción}
\begin{itemize}
...
\begin{frame}[label={sec:org186ccb0}]{Bombas centrífugas}
\begin{itemize}
...
\begin{frame}[label={sec:orga5c592e}]{Según la disposición}
\begin{itemize}
...
\begin{frame}[label={sec:org14661b8}]{Configuraciones típicas}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org337c201}]{}
\begin{center}
