...
\begin{frame}[label={sec:org912e4b6}]{Configuración AC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DiagramaUnifilarER_AC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7c8024a}]{Configuración DC+AC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DiagramaUnifilarER_AC_DC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org531aa80}]{Sistema Híbrido}
\begin{center}
...
\label{sec:org4ba222b}

\subsection{Definiciones}
\label{sec:org2d20b3f}

\begin{frame}[label={sec:org959302f}]{Acumulador electroquímico}
...
\begin{frame}[label={sec:orgc12cc09}]{Definiciones}
\begin{description}
...
\begin{frame}[label={sec:org6dfeeb3}]{Definiciones}
\begin{description}
...
\begin{frame}[label={sec:org11a21d8}]{Definiciones}
\begin{description}
...
\label{sec:org74599c2}

\begin{frame}[label={sec:orgdfa7fc8}]{Composición}
...
\begin{frame}[label={sec:org581281e}]{Reacción Química REDOX}
\begin{itemize}
\item Ánodo (+):
\end{itemize}
...
\begin{frame}[label={sec:org0e3e30c}]{Descarga}
\[
...
\begin{frame}[label={sec:orge60bbdb}]{Carga}
\[
...
\label{sec:orgabf9ea5}
\begin{frame}[label={sec:org952bef1}]{Fuente de tensión}
\begin{itemize}
...
\begin{frame}[label={sec:orgfc91251}]{Densidad del electrolito y Tensión en Abierto}
...
\begin{frame}[label={sec:orgb77ef12}]{Evolución de la tensión durante un proceso de descarga}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Bateria_SOCyDescarga.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9c98de7}]{Evolución de la tensión en un proceso de carga}
\begin{center}
...
\label{sec:org109fbd4}

\begin{frame}[label={sec:orgcac15d5}]{Temperatura baja}
\begin{itemize}
...
\begin{frame}[label={sec:orgd3c56bb}]{Temperatura alta}
\begin{itemize}
...
\begin{frame}[label={sec:org2d49939}]{Capacidad según el regimen de descarga y la temperatura}
\begin{center}
...
\subsection{Ciclado}
\label{sec:orge6500a6}
\begin{frame}[label={sec:orgb3b9b0a}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org2e5b8d8}]{Rejillas}
\begin{itemize}
...
\begin{frame}[label={sec:org34d8cf9}]{Materiales activos}
\begin{itemize}
...
\begin{frame}[label={sec:org573ca5a}]{Electrolito}
\begin{itemize}
...
\begin{frame}[label={sec:org0a9bdcb}]{Regulador Serie y paralelo}
\begin{itemize}
...
\begin{frame}[label={sec:org7736314}]{Ciclo de carga}
\begin{center}
...
\begin{frame}[label={sec:orge6b5944}]{Ciclo de descarga}
\begin{center}
...
\section{Luminarias}
\label{sec:orgadca7d5}

\begin{frame}[label={sec:org738dbc7}]{Funcionamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org43bc846}]{Degradación}
\begin{itemize}
...
\begin{frame}[label={sec:orgb692a4e}]{Fotometría}
\begin{description}
...
\begin{frame}[label={sec:org8be2a40}]{Requisitos}
\begin{itemize}
