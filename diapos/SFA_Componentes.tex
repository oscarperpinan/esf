...
\begin{frame}[label={sec:org42f238f}]{Configuración AC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DiagramaUnifilarER_AC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc15b763}]{Configuración DC+AC}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DiagramaUnifilarER_AC_DC.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org828f656}]{Sistema Híbrido}
\begin{center}
...
\label{sec:orgd7e6b7c}

\subsection{Definiciones}
\label{sec:org20e446e}

\begin{frame}[label={sec:org4e1dc34}]{Acumulador electroquímico}
...
\begin{frame}[label={sec:org7ade12f}]{Definiciones}
\begin{description}
...
\begin{frame}[label={sec:org55d3543}]{Definiciones}
\begin{description}
...
\begin{frame}[label={sec:orgc02e3e1}]{Definiciones}
\begin{description}
...
\label{sec:org2d90cc9}

\begin{frame}[label={sec:org643f291}]{Composición}
...
\begin{frame}[label={sec:org3f777ae}]{Reacción Química REDOX}
\begin{itemize}
\item Ánodo (+):
\end{itemize}
...
\begin{frame}[label={sec:orgd633a71}]{Descarga}
\[
...
\begin{frame}[label={sec:orge6b558a}]{Carga}
\[
...
\label{sec:org145a2cc}
\begin{frame}[label={sec:org9c1c2e6}]{Fuente de tensión}
\begin{itemize}
...
\begin{frame}[label={sec:org9fff6e9}]{Densidad del electrolito y Tensión en Abierto}
...
\begin{frame}[label={sec:orgb47be92}]{Evolución de la tensión durante un proceso de descarga}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Bateria_SOCyDescarga.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5b241b1}]{Evolución de la tensión en un proceso de carga}
\begin{center}
...
\label{sec:org7bbd0c3}

\begin{frame}[label={sec:org85d144d}]{Temperatura baja}
\begin{itemize}
...
\begin{frame}[label={sec:org00d15cf}]{Temperatura alta}
\begin{itemize}
...
\begin{frame}[label={sec:org516b52f}]{Capacidad según el regimen de descarga y la temperatura}
\begin{center}
...
\subsection{Ciclado}
\label{sec:orgada9823}
\begin{frame}[label={sec:orgd8e1f34}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org9e98dd7}]{Rejillas}
\begin{itemize}
...
\begin{frame}[label={sec:org77bee10}]{Materiales activos}
\begin{itemize}
...
\begin{frame}[label={sec:org9a366f7}]{Electrolito}
\begin{itemize}
...
\begin{frame}[label={sec:org5dca50d}]{Regulador Serie y paralelo}
\begin{itemize}
...
\begin{frame}[label={sec:org916a44d}]{Ciclo de carga}
\begin{center}
...
\begin{frame}[label={sec:org3e17bcc}]{Ciclo de descarga}
\begin{center}
...
\section{Luminarias}
\label{sec:orged37784}

\begin{frame}[label={sec:orga6f87db}]{Funcionamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgc7bdb4d}]{Degradación}
\begin{itemize}
...
\begin{frame}[label={sec:orgdb882ba}]{Fotometría}
\begin{description}
...
\begin{frame}[label={sec:org0788002}]{Requisitos}
\begin{itemize}
