...
\date{}
\title{Energía Producida por una SFCR}
...
\hypersetup{
 ...
 pdftitle={Energía Producida por una SFCR},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:orga4a01ca}
\begin{frame}[label={sec:orgf13a7af}]{Potencia en un SFCR}
\begin{itemize}
...
\begin{frame}[label={sec:orgb528860}]{Energía producida}
...
\begin{frame}[label={sec:orgf6975bd}]{Productividad}
...
\begin{frame}[label={sec:orgc2148fe}]{Factor de sombras}
\begin{itemize}
...
\label{sec:org5caa54e}

\begin{frame}[label={sec:org40b58eb}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org083e427}]{Desglose de pérdidas}
\begin{itemize}
...
\begin{frame}[label={sec:orga858604}]{Valores reales}
\begin{itemize}
