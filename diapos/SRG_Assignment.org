...
2. Compute the clearness index, $K_{Tm}$, and fraction of diffuse, $F_{Dm}$, with the 12 monthly averages of global irradiation on the horizontal plane (step #8 or #5 of previous assignment). Compute the beam and diffuse components of solar radiation on the horizontal plane.
