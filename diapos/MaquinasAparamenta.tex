...
\begin{frame}[label={sec:org8672d7b}]{Transformador}
\begin{itemize}
...
\begin{frame}[label={sec:org0e8fa20}]{Motores}
...
\begin{frame}[label={sec:orga3599b2}]{Motores}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org005c6f3}]{Generadores}
...
\begin{frame}[label={sec:org58a5c45}]{Generadores}
\begin{block}{Dinamo}
\begin{itemize}
\item \(f_{1}=0\); \(f_{L}=0\);
...
\label{sec:orgdfdc62a}


\subsection{Definición y Funciones}
\label{sec:org5506415}
\begin{frame}[label={sec:orgb279e3e}]{Definición}
...
\begin{frame}[label={sec:orgd7f6f5c}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:org113a961}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:org24d53a0}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:org066750a}]{Arco Eléctrico}
\begin{itemize}
...
\begin{frame}[label={sec:org99b9c7f}]{Poder de corte y cierre}
\begin{description}
...
\label{sec:org9f8f7c7}
\begin{frame}[label={sec:org7cfbea0}]{Dispositivos simples}
...
\begin{frame}[label={sec:org86a639b}]{Dispositivos simples}
...
\begin{frame}[label={sec:org6ba2c17}]{Interruptor magnetotérmico}
\begin{itemize}
...
\begin{frame}[label={sec:org0c5483c}]{Interruptor Magnetotérmico}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/SeccionMagnetotermico.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7209136}]{Interruptor diferencial}
\begin{itemize}
...
\begin{frame}[label={sec:org0581c7f}]{Interruptor Diferencial}
\begin{center}
