...
\begin{frame}[label={sec:org5e25e6b}]{Interacción entre Conductores}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga3f58e8}]{Flujo Magnético}
...
\begin{frame}[label={sec:org8085a22}]{Ley de Faraday}
\begin{itemize}
...
\label{sec:orgb1a5759}
\subsection{Introducción}
\label{sec:org71ab13c}

\begin{frame}[label={sec:orgc7edaa0}]{Máquina Eléctrica}
...
\begin{frame}[label={sec:org75a9268}]{Partes de una Máquina}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orged15999}]{Inductor e Inducido}
...
\label{sec:org93fbcc1}
\begin{frame}[label={sec:orgdfa0341}]{Motor asíncrono o de inducción}
\begin{itemize}
...
\begin{frame}[label={sec:org337a9e6}]{Motor de corriente continua}
\begin{itemize}
...
\label{sec:org2920b89}

\begin{frame}[label={sec:orgeac10a2}]{Generador Síncrono o Alternador}
\begin{itemize}
...
\begin{frame}[label={sec:orga083471}]{Generador Asíncrono}
\begin{columns}
...
\begin{frame}[label={sec:org6459c0a}]{Generador DC}
\begin{itemize}
...
\label{sec:org3da4ad5}
\begin{frame}[label={sec:orga9e3693}]{Fundamento}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc0c09c2}]{Relación de Transformación}
\begin{align*}
...
\label{sec:org4abb003}

\subsection{Sistema de Suministro Eléctrico}
\label{sec:org272364c}
\begin{frame}[label={sec:orga807fd8}]{Sistema de suministro eléctrico}
...
\begin{frame}[label={sec:org18d3db8}]{Componentes del Sistema de Suministro Eléctrico}
\begin{center}
...
\label{sec:org778eb37}
\begin{frame}[label={sec:org79880fe}]{Aparamenta}
...
\begin{frame}[label={sec:org6edfc97}]{Protección}
\begin{itemize}
...
\begin{frame}[label={sec:org5673a68}]{Aislamiento}
...
\begin{frame}[label={sec:orgf013ea0}]{Control}
...
\begin{frame}[label={sec:orgb67405c}]{Arco Eléctrico}
\begin{itemize}
...
\begin{frame}[label={sec:org057d923}]{Poder de corte y cierre}
\begin{description}
...
\label{sec:org25e664b}

\begin{frame}[label={sec:org782f326}]{Seccionador}
\begin{itemize}
...
\begin{frame}[label={sec:orga92985f}]{Interruptor magnetotérmico}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9953b28}]{Interruptor diferencial}
\begin{itemize}
...
\section{Recursos}
\label{sec:orgb00488f}

\begin{frame}[label={sec:org133cd50}]{Bibliografía}
\begin{itemize}
