...
\begin{frame}[label={sec:orgf19566a}]{Planteamiento}
\begin{itemize}
...
\section{Estadística}
\label{sec:org8e78e58}


\begin{frame}[label={sec:org95b8602}]{Variable aleatoria y proceso estocástico}
\begin{itemize}
...
\begin{frame}[label={sec:orge6a5034}]{Función de densidad de probabilidad}
...
\begin{frame}[label={sec:org62d1242}]{Media, varianza y desviación estándar}
\begin{itemize}
...
\begin{frame}[label={sec:org488ff2e}]{Combinación lineal de variables aleatorias}
\begin{itemize}
...
\begin{frame}[label={sec:org5074016}]{Media y varianza de la media muestral}
\begin{itemize}
...
\begin{frame}[label={sec:org9f89d1d}]{Media y varianza de la media muestral}
...
\begin{frame}[label={sec:orga2f646d}]{Mediana y cuartiles}
\begin{itemize}
...
\section{Gráficos}
\label{sec:org8584e91}


\begin{frame}[label={sec:org412c270}]{Función de Densidad de Probabilidad}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/FuncionDensidadProbabilidad.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgcff41d7}]{Histograma}
\begin{center}
...
\begin{frame}[label={sec:org81e2f96}]{Gráficos boxplot}
\begin{center}
...
\begin{frame}[label={sec:org61ae24f}]{Gráficos de dispersión}
\begin{center}
...
\begin{frame}[label={sec:org7cddef8}]{Matrices de gráficos de dispersión}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/Splom.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6c1d6bb}]{Gráficos Fotovoltaicos\footnote{Más ejemplos en el informe \guillemotleft{}\href{https://iea-pvps.org/key-topics/analytical-monitoring-of-pv-systems-final/}{Analytical Monitoring of Grid-connected Photovoltaic Systems}\guillemotright{} de la Task 13 del IEA-PVPS.}}
\begin{itemize}
...
\label{sec:org93a8283}

\begin{frame}[label={sec:orgba1c538}]{Desviación entre modelo y observación}
\begin{itemize}
...
\begin{frame}[label={sec:orgf195c96}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org2cedd2b}]{Estimadores frecuentes: MBD y RMSD}
\begin{itemize}
...
\begin{frame}[label={sec:orgccccfa8}]{Estimadores frecuentes: MBE y RMSD}
...
\begin{frame}[label={sec:org61c0107}]{Otros estimadores: MAD}
\begin{itemize}
...
\begin{frame}[label={sec:org4f3ff67}]{Otros estimadores: t y d}
\begin{itemize}
...
\begin{frame}[label={sec:org1a2166b}]{Correlación}
...
\begin{frame}[label={sec:org062d2e6}]{Diagramas de Taylor}
\begin{itemize}
...
\begin{frame}[label={sec:orged00c59}]{Diagramas de Taylor}
\[
\sigma^2_{\mathbf{D}} = \sigma^2_{\mathbf{O}}  + \sigma^2_{\mathbf{M}}
- 2 \cdot \sigma_{\mathbf{O}} \cdot \sigma_{\mathbf{M}} \cdot r 
\]
...
\begin{frame}[label={sec:org8c1a9f1}]{Target Diagram}
\begin{itemize}
...
\begin{frame}[label={sec:orgc8227cb}]{Target Diagram}
\begin{columns}
...
\label{sec:orgcbdff50}

\begin{frame}[label={sec:org47ced18}]{Planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org19a8aaf}]{Coherencia estadística}
\begin{itemize}
...
\begin{frame}[label={sec:org75f6851}]{Método de Chauvenet}
...
\begin{frame}[label={sec:org1cde2e7}]{Método de Chauvenet}
\begin{enumerate}
...
\begin{frame}[label={sec:orge71857c}]{Método de Chauvenet}
\begin{itemize}
...
\begin{frame}[label={sec:org02012d7}]{Métodos gráficos}
\begin{itemize}
