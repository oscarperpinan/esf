...
\begin{frame}[label={sec:orgbafeffc}]{Función de densidad de probabilidad}
...
\begin{frame}[label={sec:org66d1e5b}]{Media, varianza y desviación estándar}
\begin{itemize}
...
\begin{frame}[label={sec:org07f1d2d}]{Combinación lineal de variables aleatorias}
\begin{itemize}
...
\begin{frame}[label={sec:orga96d41e}]{Media y varianza de la media muestral}
\begin{itemize}
...
\begin{frame}[label={sec:org9595ac6}]{Media y varianza de la media muestral}
...
\begin{frame}[label={sec:org26cf791}]{Planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4578336}]{Coherencia estadística}
\begin{itemize}
...
\begin{frame}[label={sec:org8b6b634}]{Método de Chauvenet}
...
\begin{frame}[label={sec:org6b1c66c}]{Método de Chauvenet}
\begin{enumerate}
...
\begin{frame}[label={sec:orgbf07c85}]{Método de Chauvenet}
\begin{itemize}
