...
\begin{frame}[label={sec:org1f71de3}]{Planteamiento}
\begin{itemize}
...
\section{Estadística}
\label{sec:org8523c80}


\begin{frame}[label={sec:orgaa2c580}]{Variable aleatoria y proceso estocástico}
\begin{itemize}
...
\begin{frame}[label={sec:org067c309}]{Función de densidad de probabilidad}
...
\begin{frame}[label={sec:org5f2e18f}]{Media, varianza y desviación estándar}
\begin{itemize}
...
\begin{frame}[label={sec:org4dfcfb7}]{Combinación lineal de variables aleatorias}
\begin{itemize}
...
\begin{frame}[label={sec:org9501263}]{Media y varianza de la media muestral}
\begin{itemize}
...
\begin{frame}[label={sec:org57bc476}]{Media y varianza de la media muestral}
...
\begin{frame}[label={sec:org50da541}]{Error de funcionamiento \(V_g \sim T_c\)}
\begin{center}
...
\label{sec:org7f0010a}

\begin{frame}[label={sec:org844d624}]{Desviación entre modelo y observación}
\begin{itemize}
...
\begin{frame}[label={sec:orga46f0a5}]{Planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5e8b9c8}]{Coherencia estadística}
\begin{itemize}
...
\begin{frame}[label={sec:org3f904b6}]{Método de Chauvenet}
...
\begin{frame}[label={sec:org98256a3}]{Método de Chauvenet}
\begin{enumerate}
...
\begin{frame}[label={sec:org76f4103}]{Método de Chauvenet}
\begin{itemize}
