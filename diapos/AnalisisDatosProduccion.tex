...
\begin{frame}[label={sec:org9b7a584}]{Planteamiento}
\begin{itemize}
...
\section{Estadística}
\label{sec:orge5a1996}


\begin{frame}[label={sec:orgdf27e0d}]{Variable aleatoria y proceso estocástico}
\begin{itemize}
...
\begin{frame}[label={sec:orgb6ce10c}]{Función de densidad de probabilidad}
...
\begin{frame}[label={sec:orgc3b97a7}]{Media, varianza y desviación estándar}
\begin{itemize}
...
\begin{frame}[label={sec:org24ca23e}]{Error de funcionamiento \(V_g \sim T_c\)}
\begin{center}
...
\label{sec:orgd4151dd}

\begin{frame}[label={sec:orgfb93a04}]{Desviación entre modelo y observación}
\begin{itemize}
...
\begin{frame}[label={sec:org5e3e5d4}]{Planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge2a803f}]{Coherencia estadística}
\begin{itemize}
...
\begin{frame}[label={sec:org456a4c5}]{Método de Chauvenet}
