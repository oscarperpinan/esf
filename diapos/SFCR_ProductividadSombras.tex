...
\label{sec:org4be0343}

\subsection{Procedimiento de cálculo}
\label{sec:org451dc4b}

\begin{frame}[label={sec:orgd18269c}]{Potencia en un SFCR}
\begin{itemize}
...
\begin{frame}[label={sec:org01fb441}]{Energía producida}
...
\begin{frame}[label={sec:org2ce3765}]{Productividad}
...
\begin{frame}[label={sec:orgf24fa52}]{Performance Ratio}
\begin{itemize}
...
\begin{frame}[label={sec:org9d729b9}]{Performance Ratio}
...
\begin{frame}[label={sec:org3be08b0}]{Performance Ratio}
...
\begin{frame}[label={sec:orgb7f5800}]{Factor de sombras}
\begin{itemize}
...
\label{sec:orge3f7608}

\subsection{Sombras Lejanas}
\label{sec:org2441c91}

\begin{frame}[label={sec:org30af572}]{Sombras en el horizonte}
\begin{center}
...
\label{sec:org07362e6}

\begin{frame}[label={sec:orgd60268b}]{Sombras entre filas}
\begin{center}
...
\begin{frame}[label={sec:orge275e0e}]{Radiación promedio}
...
\begin{frame}[label={sec:orgd31c119}]{Separación de Seguidores Horizontal N-S}
\begin{center}
\includegraphics[angle=90,width=.9\linewidth]{../figs/AbacoSeguidorHorizSombra_Ene10.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgfc88e35}]{Backtracking}
\begin{itemize}
...
\begin{frame}[label={sec:org0fa8655}]{Backtracking}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/BackTracking.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4419369}]{Separación con backtracking}
\begin{center}
\includegraphics[angle=90,width=.9\linewidth]{../figs/AbacoHorizBT_Ene10.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org66137b8}]{Limitación de ángulo}
\begin{itemize}
...
\label{sec:orgda7da7d}


\begin{frame}[label={sec:org11ebc42}]{Elección de separaciones}
...
\begin{frame}[label={sec:org4eb8606}]{Elección de separaciones}
\begin{itemize}
...
\begin{frame}[label={sec:org69f4049}]{ROT y Coste de la energía producida}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
\item Coste Energía
...
\section{Resumen}
\label{sec:org851e327}

\begin{frame}[label={sec:org040a69d}]{Ocupación de terreno y productividad}
\begin{center}
\begin{tabular}{lrl}
