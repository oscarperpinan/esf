...
\begin{frame}[label={sec:orgbcc0598}]{Separación de seguidores Doble Eje}
\begin{center}
...
\begin{frame}[label={sec:org02af0cc}]{Radiación promedio}
...
\begin{frame}[label={sec:org80d5520}]{Separación de Seguidores Doble Eje}
\begin{columns}
...
\label{sec:org3083c2f}

\begin{frame}[label={sec:org1b36598}]{Separación de Seguidores Eje Horizontal}
\begin{center}
...
\begin{frame}[label={sec:org4a98c68}]{Separación de Seguidores Horizontal N-S}
\begin{center}
\includegraphics[angle=90,height=0.9\textheight]{../figs/AbacoSeguidorHorizSombra_Ene10.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org81612f2}]{Backtracking}
\begin{itemize}
...
\begin{frame}[label={sec:orgee7d257}]{Backtracking}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/BackTracking.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga47f3aa}]{Separación con backtracking}
\begin{center}
\includegraphics[angle=90,height=0.9\textheight]{../figs/AbacoHorizBT_Ene10.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org457a760}]{Limitación de ángulo}
\begin{itemize}
...
\label{sec:org907683e}


\begin{frame}[label={sec:org2a9ac77}]{Elección de separaciones}
...
\begin{frame}[label={sec:org7da03fb}]{Elección de separaciones}
\begin{itemize}
...
\begin{frame}[label={sec:orgb73ef4c}]{Ocupación óptima}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1f73bf6}]{Separaciones y coste de la energía}
\begin{center}
