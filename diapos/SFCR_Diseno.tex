...
\label{sec:orgc72392c}

\begin{frame}[label={sec:org971adf8}]{Inclinación y Orientacion}
...
\begin{frame}[label={sec:orga147f17}]{Modulos en serie}
\begin{itemize}
...
\begin{frame}[label={sec:orgfe6bc81}]{Ramas en paralelo}
\begin{itemize}
...
\begin{frame}[label={sec:org0db9dc2}]{Configuración del generador}
...
\begin{frame}[label={sec:org30769f8}]{Configuración eléctrica y estructura}
\begin{itemize}
...
\begin{frame}[label={sec:org1e4e7ad}]{Potencia del generador}
\begin{itemize}
...
\begin{frame}[label={sec:org63260ae}]{Potencia del generador}
\begin{itemize}
