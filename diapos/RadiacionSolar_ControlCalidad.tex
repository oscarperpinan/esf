...
\section{Estadística}
\label{sec:orgc82c0e7}


\begin{frame}[label={sec:org0f0ebca}]{Variable aleatoria y proceso estocástico}
\begin{itemize}
...
\begin{frame}[label={sec:org5dfe187}]{Función de densidad de probabilidad}
...
\begin{frame}[label={sec:org886c8b6}]{Media, varianza y desviación estándar}
\begin{itemize}
...
\begin{frame}[label={sec:org7cad64a}]{Combinación lineal de variables aleatorias}
\begin{itemize}
...
\begin{frame}[label={sec:orgaaeee11}]{Media y varianza de la media muestral}
\begin{itemize}
...
\begin{frame}[label={sec:orgc5b4ae9}]{Media y varianza de la media muestral}
...
\begin{frame}[label={sec:org246af57}]{Mediana y cuartiles}
\begin{itemize}
...
\section{Gráficos}
\label{sec:org8e7ceca}


\begin{frame}[label={sec:org00690b5}]{Función de Densidad de Probabilidad}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/FuncionDensidadProbabilidad.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org13668e9}]{Histograma}
\begin{center}
...
\begin{frame}[label={sec:orgb94fa80}]{Gráficos boxplot}
\begin{center}
...
\begin{frame}[label={sec:org74a66fe}]{Gráficos de dispersión}
\begin{center}
...
\begin{frame}[label={sec:org6c795fe}]{Matrices de gráficos de dispersión}
\begin{center}
...
\label{sec:orga182531}

\begin{frame}[label={sec:orgc40d075}]{Introducción}
...
\begin{frame}[label={sec:org464c5af}]{Límites físicos}
...
\begin{frame}[label={sec:orgf35ff3d}]{Límites físicos}
...
\begin{frame}[label={sec:org3a23e05}]{Tests de variabilidad}
...
\begin{frame}[label={sec:org94caf61}]{Tests de envolvente}
...
\begin{frame}[label={sec:org57281f5}]{Coherencia espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org15100f4}]{Coherencia espacial}
\begin{block}{Pasos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfdc7890}]{Coherencia estadística}
...
\begin{frame}[label={sec:orgad6a92b}]{Método de Chauvenet}
\begin{enumerate}
...
\begin{frame}[label={sec:org4b8aa0f}]{Método de Chauvenet}
\begin{columns}
...
\label{sec:org096f9d1}

\begin{frame}[label={sec:org517b19a}]{Desviación entre modelo y observación}
\begin{itemize}
...
\begin{frame}[label={sec:org0cea34d}]{Exactitud (\emph{bias}) y Precisión (\emph{variance})}
\begin{center}
...
\begin{frame}[label={sec:org74fc8c0}]{Estimadores frecuentes: MBD y RMSD}
\begin{itemize}
...
\begin{frame}[label={sec:org2686508}]{Estimadores frecuentes: MBE y RMSD}
...
\begin{frame}[label={sec:orgc0589b0}]{Otros estimadores: MAD}
\begin{itemize}
...
\begin{frame}[label={sec:orgeca3132}]{Otros estimadores: t y d}
\begin{itemize}
...
\begin{frame}[label={sec:orga3bed29}]{Correlación}
...
\begin{frame}[label={sec:orga8fb304}]{Diagramas de Taylor}
\begin{itemize}
...
\begin{frame}[label={sec:org7a2a4fc}]{Diagramas de Taylor}
\[
\sigma^2_{\mathbf{D}} = \sigma^2_{\mathbf{O}}  + \sigma^2_{\mathbf{M}}
- 2 \cdot \sigma_{\mathbf{O}} \cdot \sigma_{\mathbf{M}} \cdot r 
\]
...
\begin{frame}[label={sec:org66c332f}]{Target Diagram}
\begin{itemize}
...
\begin{frame}[label={sec:org260a57b}]{Target Diagram}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
