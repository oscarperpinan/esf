...
\label{sec:org6b50999}

\begin{frame}[label={sec:org65dcc2a}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org52f749a}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbac9a18}]{Ángulo de Inclinación}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org28ad3f2}]{Bases de Datos de Radiación Solar}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga440866}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf490082}]{Variabilidad Temporal}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org96fd71e}]{Variabilidad Espacial}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/SpatialVariability.jpg}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc755817}]{Estimación a partir de Medidas}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org45726d0}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:org9dcffa0}
\begin{frame}[label={sec:orgebe9b16}]{Introducción}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org72f8fc1}]{Límites físicos: Irradiación Diaria}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgefdcb4b}]{Coherencia espacial: planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7099e96}]{Coherencia espacial: procedimiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org86cd9ac}]{Métricas para diferencias}
\begin{itemize}
