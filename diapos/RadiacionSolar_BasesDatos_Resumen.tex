...
\label{sec:orgd359a3c}

\begin{frame}[label={sec:org5ab00b5}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfad2c8c}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org6b250eb}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org7a52207}]{Bases de Datos de Radiación Solar}
...
\begin{frame}[label={sec:orgef3c4b2}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org8803d46}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:org396205a}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orga150124}]{Estimación a partir de Medidas}
...
\begin{frame}[label={sec:org00e40a9}]{Fuentes de datos}
\begin{itemize}
...
\begin{frame}[label={sec:org3b84e56}]{Otros recursos}
...
\label{sec:org6af41fb}

\begin{frame}[label={sec:org933fd04}]{Radiómetros}
\begin{itemize}
...
\begin{frame}[label={sec:org2060c42}]{SSE-NASA}
...
\begin{frame}[label={sec:org552a647}]{EUMETSAT - SAF}
...
\label{sec:orgb6a6b69}

\begin{frame}[label={sec:orgd7f718c}]{Herramientas}
...
\begin{frame}[label={sec:org79579a9},fragile]{PVGIS - \texttt{r.sun}}
...
\label{sec:org769a1ab}
\begin{frame}[label={sec:orgd79e8fe}]{Introducción}
...
\begin{frame}[label={sec:org7552970}]{Límites físicos: Irradiación Diaria}
\begin{itemize}
...
\begin{frame}[label={sec:orgff2c19a}]{Coherencia espacial: planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:org0978004}]{Coherencia espacial: procedimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org289eb55}]{Métricas para diferencias}
\begin{itemize}
