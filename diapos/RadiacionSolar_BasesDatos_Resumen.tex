...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf2bfc0e}]{Bases de Datos de Radiación Solar}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org35f355e}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc17b230}]{Variabilidad Temporal}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org997461b}]{Variabilidad Espacial}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/SpatialVariability.jpg}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6a60216}]{Estimación a partir de Medidas}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org84d4eb2}]{Fuentes de datos}
\begin{itemize}
...
\label{sec:orga23bb3f}
\begin{frame}[label={sec:org92b6ef4}]{Introducción}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5cc1a9b}]{Límites físicos: Irradiación Diaria}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge1c3a48}]{Coherencia espacial: planteamiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb4d6526}]{Coherencia espacial: procedimiento}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org60828c5}]{Métricas para diferencias}
\begin{itemize}
