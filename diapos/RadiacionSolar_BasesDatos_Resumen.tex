...
\label{sec:orgde624f2}

\begin{frame}[label={sec:orgeb0186f}]{Radiación Solar y Sistemas Fotovoltaicos}
\begin{itemize}
...
\begin{frame}[label={sec:org4683271}]{La radiación solar no se puede calcular analíticamente}
\begin{itemize}
...
\begin{frame}[label={sec:org38ada84}]{Ángulo de Inclinación}
\begin{itemize}
...
\begin{frame}[label={sec:org2310db8}]{Bases de Datos de Radiación Solar}
...
\begin{frame}[label={sec:org766d8d4}]{Variabilidad Temporal y Espacial}
\begin{itemize}
...
\begin{frame}[label={sec:org9d2f816}]{Variabilidad Temporal}
...
\begin{frame}[label={sec:orgc67da08}]{Variabilidad Espacial}
\begin{center}
...
\begin{frame}[label={sec:orgb4d0b8b}]{Estimación a partir de Medidas}
...
\begin{frame}[label={sec:orge1ae9d3}]{Fuentes de datos}
\begin{itemize}
...
\begin{frame}[label={sec:orgfc5210f}]{Otros recursos}
...
\label{sec:org828b91e}

\begin{frame}[label={sec:orgaf7a32c}]{Radiómetros}
\begin{itemize}
...
\begin{frame}[label={sec:org88f76b7}]{SSE-NASA}
...
\begin{frame}[label={sec:orgffe6770}]{EUMETSAT - SAF}
...
\label{sec:orgbec3dfa}

\begin{frame}[label={sec:org35806c4}]{Herramientas}
...
\begin{frame}[label={sec:org7947fb5},fragile]{PVGIS - \texttt{r.sun}}
...
\label{sec:org9c62f12}
\begin{frame}[label={sec:org41d4e07}]{Introducción}
...
\begin{frame}[label={sec:orgba559fd}]{Límites físicos: Irradiación Diaria}
\begin{itemize}
...
\begin{frame}[label={sec:orgbb13206}]{Coherencia espacial: planteamiento}
\begin{itemize}
...
\begin{frame}[label={sec:orgefd8f74}]{Coherencia espacial: procedimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org38cad6a}]{Métricas para diferencias}
\begin{itemize}
