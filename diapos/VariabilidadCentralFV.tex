...
\begin{frame}[label={sec:org7dfdbe8}]{Los Sistemas Fotovoltaicos y la Red Eléctrica}
\begin{itemize}
...
\begin{frame}[label={sec:orgd32f1a7}]{Los Sistemas Fotovoltaicos y la Red Eléctrica}
\begin{itemize}
...
\begin{frame}[label={sec:org160cd3b}]{Variabilidad de la Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:orge1ecd92}]{Variabilidad de la Radiación}
\begin{itemize}
...
\label{sec:org8aadee0}

\begin{frame}[label={sec:org6a8be48}]{Generación y Demanda}
...
\begin{frame}[label={sec:orgb72d1b0}]{Programación de la generación}
...
\begin{frame}[label={sec:orgebbfd29}]{Ejemplo: proyecto europeo PVCROPS}
...
\begin{frame}[label={sec:org9fc22d8}]{Predicciones agregadas}
Las predicciones obtenidas mejoran cuando las predicciones se aplican
a un conjunto de sistemas.
\end{frame}

\section{Variabilidad de la Potencia}
\label{sec:org7e5e78b}

\begin{frame}[label={sec:org9054f30}]{Variabilidad Conjunta}
...
\begin{frame}[label={sec:org68b705c}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:orga5c2d82}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:org786c86c}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:orgc898b5c}]{Normativas de red}
\begin{itemize}
...
\begin{frame}[label={sec:orgaae7a7f}]{Definiciones de rampas}
...
\begin{frame}[label={sec:orgd4195c6}]{Ejemplos de definiciones de rampas}
\begin{itemize}
...
\begin{frame}[label={sec:orge3f74d5}]{Limitación de rampas}
...
\begin{frame}[label={sec:org7d3ad78}]{Modelo de la peor fluctuación}
...
\begin{frame}[label={sec:org99a5308}]{Modelo de la peor fluctuación}
\begin{columns}
...
\begin{frame}[label={sec:orgbbc8a0e}]{Modelo de la peor fluctuación}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/ModeloPeorFluctuacion.pdf}
