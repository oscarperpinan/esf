...
\begin{frame}[label={sec:orgae4e6d2}]{Los Sistemas Fotovoltaicos y la Red Eléctrica}
\begin{itemize}
...
\begin{frame}[label={sec:org8501d84}]{Los Sistemas Fotovoltaicos y la Red Eléctrica}
\begin{itemize}
...
\begin{frame}[label={sec:orgd1329bd}]{Variabilidad de la Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:orgb7d66ea}]{Variabilidad de la Radiación}
\begin{itemize}
...
\label{sec:orga5bdb1e}

\begin{frame}[label={sec:orga430faa}]{Generación y Demanda}
...
\begin{frame}[label={sec:orga457f21}]{Programación de la generación}
...
\begin{frame}[label={sec:orga68bb6f}]{Ejemplo: proyecto europeo PVCROPS}
...
\begin{frame}[label={sec:orgccaf2a1}]{Predicciones agregadas}
Las predicciones obtenidas mejoran cuando las predicciones se aplican
a un conjunto de sistemas.
\end{frame}

\section{Variabilidad de la Potencia}
\label{sec:org3438aba}

\begin{frame}[label={sec:org2404499}]{Variabilidad Conjunta}
...
\begin{frame}[label={sec:orgcfa9691}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:org26a8301}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:org4998fdc}]{Dispersión espacial dentro de una central}
...
\begin{frame}[label={sec:org505d75c}]{Normativas de red}
\begin{itemize}
...
\begin{frame}[label={sec:org5e787f7}]{Definiciones de rampas}
...
\begin{frame}[label={sec:orgb541d62}]{Ejemplos de definiciones de rampas}
\begin{itemize}
...
\begin{frame}[label={sec:orgee5ccfc}]{Limitación de rampas}
...
\begin{frame}[label={sec:orga2536b3}]{Modelo de la peor fluctuación}
...
\begin{frame}[label={sec:orgaeea843}]{Modelo de la peor fluctuación}
\begin{columns}
...
\begin{frame}[label={sec:org3ac78cf}]{Modelo de la peor fluctuación}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\includegraphics[width=\textwidth]{../figs/ModeloPeorFluctuacion.pdf}
