...
\label{sec:org37d48e8}
\subsection{Conducción eléctrica}
\label{sec:orge1f89fa}

\begin{frame}[label={sec:org4b55ef6}]{Bandas de energía}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgfa51a10}]{Bandas de energía}
\begin{center}
...
\begin{frame}[label={sec:orgf46cac5}]{Conductores, aislantes y semiconductores}
...
\begin{frame}[label={sec:org9c38d54}]{Conductores, aislantes y semiconductores}
...
\label{sec:org811f1d9}

\begin{frame}[label={sec:org3413148}]{Red cristalina de Si (T = \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org603c37d}]{Generación de electrón-hueco (T > \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:org77338b1}]{Generación de electrón-hueco}
\begin{columns}
...
\begin{frame}[plain,label={sec:orga5089b4}]{Recombinación de un par electrón-hueco}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org4776ee9}
\begin{frame}[label={sec:orge275e90}]{Definición}
...
\begin{frame}[label={sec:orge7cd690}]{Tipo n}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:org070b011}]{Tipo n}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org2920029}]{Tipo p}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:org7dc96aa}]{Tipo p}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org131c5a4}
\begin{frame}[label={sec:org8c4d3ea}]{Unión p-n}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:org20bc1e1}]{Conducción en una unión p-n}
\begin{itemize}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[label={sec:org670ef14}]{Corriente de Difusión}
\begin{itemize}
...
\begin{frame}[label={sec:org2031394}]{Corriente de Arrastre}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgfb98674}]{Equilibrio en una unión p-n}
\begin{itemize}
...
\begin{frame}[plain,label={sec:orgc3121d4}]{Polarización en directa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:orgca365e8}]{Polarización en inversa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\subsection{Diodo}
\label{sec:orgfd0e345}

\begin{frame}[label={sec:org7f13371}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:orgb5b64d1}]{Ecuación del Diodo}
\begin{itemize}
...
\begin{frame}[label={sec:orgabca6a3}]{}
\begin{center}
...
\label{sec:org670aac9}

\begin{frame}[label={sec:orgfa73b27}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org946b7d3}]{Efecto fotoeléctrico}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org3f10863}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org420c1bc}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\label{sec:orgb232de7}

\begin{frame}[label={sec:org1a50ca8}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}
...
\label{sec:org8af5f7d}
\begin{frame}[label={sec:org3469a14}]{Característica I-V de iluminación}
$$I=I_{L}-I_{D}$$
...
\begin{frame}[label={sec:orgd77b37a}]{Isc y Voc}
...
\begin{frame}[label={sec:orgbc8fccf}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:orgc9d8d6f}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:orgfdc7e67}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:org4b947c2}]{Factor de forma y Eficiencia}
\begin{itemize}
...
\begin{frame}[label={sec:org8655f5a}]{Condiciones Estándar de Medida}
\begin{itemize}
...
\label{sec:org2ab802f}

\begin{frame}[label={sec:orgb0fbb2e}]{Método Simplificado: Factor de Forma Constante}
$$FF=FF^{*}$$
...
\begin{frame}[label={sec:org38762cd}]{Procedimiento}
\begin{itemize}
...
\begin{frame}[label={sec:org6a2e712}]{Ejercicio de Cálculo}
...
\label{sec:orgfda97e5}

\begin{frame}[label={sec:orgd4361cf}]{Circuito equivalente}
\begin{center}
...
\begin{frame}[label={sec:orgfc28b55}]{Resistencia Serie: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org38e4583}]{Resistencia Serie: Curva PV}
\begin{itemize}
\item Resistencia de contactos metálicos con el semiconductor
...
\begin{frame}[label={sec:org900e7d3}]{Resistencia paralelo: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org6aca479}]{Resistencia paralelo: Curva PV}
\begin{itemize}
\item Fugas de corriente en bordes de célula
...
\section{Fabricación}
\label{sec:orgfa3c4d8}

\begin{frame}[label={sec:org2781f62}]{}
\begin{center}
...
\begin{frame}[label={sec:org799f863}]{Purificación de silicio}
\begin{itemize}
...
\begin{frame}[label={sec:orgf03b3ea}]{Formación de obleas}
\begin{itemize}
...
\begin{frame}[label={sec:orgf03b2a0}]{Formación de células}
\begin{itemize}
