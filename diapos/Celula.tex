...
\label{sec:org76ee2af}
\subsection{Conducción eléctrica}
\label{sec:orgc3e106e}

\begin{frame}[label={sec:org55f8a04}]{Bandas de energía}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org18e9541}]{Bandas de energía}
\begin{center}
...
\begin{frame}[label={sec:org94afd95}]{Conductores, aislantes y semiconductores}
...
\begin{frame}[label={sec:org8a38d2b}]{Conductores, aislantes y semiconductores}
...
\label{sec:orgd0ec0a4}

\begin{frame}[label={sec:orgfa51d53}]{Red cristalina de Si (T = \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6637be4}]{Generación de electrón-hueco (T > \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\begin{frame}[plain,label={sec:org02950b2}]{Generación de electrón-hueco}
\begin{columns}
...
\begin{frame}[plain,label={sec:org0f9c8b1}]{Recombinación de un par electrón-hueco}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:org20a4a65}]{Tipo n}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:org91599ba}]{Tipo p}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orge9bfd58}]{Corriente de Difusión}
\begin{itemize}
...
\begin{frame}[label={sec:org80ddeca}]{Corriente de Arrastre}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orga673bbc}]{Equilibrio en una unión p-n}
\begin{itemize}
...
\begin{frame}[plain,label={sec:orgee814ac}]{Polarización en directa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:org9c349e6}]{Polarización en inversa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\subsection{Diodo}
\label{sec:org032a62f}

\begin{frame}[label={sec:orgb52b492}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org710562d}]{Ecuación del Diodo}
\begin{itemize}
...
\begin{frame}[label={sec:orgd83a469}]{}
\begin{center}
...
\label{sec:orgdb03890}

\begin{frame}[label={sec:org25a94a8}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf9aa565}]{Efecto fotoeléctrico}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgd8ea4a9}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgfc30358}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\label{sec:org5e4f6d2}

\begin{frame}[label={sec:org565317e}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}
...
\label{sec:orgdebe241}
\begin{frame}[label={sec:org32b3286}]{Característica I-V de iluminación}
$$I=I_{L}-I_{D}$$
...
\begin{frame}[label={sec:orgc731ca6}]{Isc y Voc}
...
\begin{frame}[label={sec:orgd040a97}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:org3f24651}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:orgf86ed77}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:org009ca3f}]{Factor de forma y Eficiencia}
\begin{itemize}
...
\begin{frame}[label={sec:orga9b6c4e}]{Resistencia Serie: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org6883531}]{Resistencia Serie: Curva PV}
\begin{itemize}
\item Resistencia de contactos metálicos con el semiconductor
...
\begin{frame}[label={sec:org0298b7c}]{Resistencia paralelo: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org3342564}]{Resistencia paralelo: Curva PV}
\begin{itemize}
\item Fugas de corriente en bordes de célula
...
\label{sec:org4704bbe}

\begin{frame}[label={sec:orgb773f96}]{Método de J.M. Ruiz}
\begin{itemize}
\item Normalización
\end{itemize}
...
\begin{frame}[label={sec:org244b3b8}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org102a061}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2af6b9}]{Método de J.M. Ruiz}
\begin{itemize}
\item Itinerario
...
\begin{frame}[label={sec:org3265177}]{Simplificado: Factor de Forma Constante}
$$FF=FF^{*}$$
...
\begin{frame}[label={sec:org3c837ca}]{Ejercicio de Cálculo}
...
\begin{frame}[label={sec:orgf2059b4}]{Formación de células}
\begin{itemize}
