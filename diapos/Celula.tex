...
\label{sec:org5dfd8b9}
\subsection{Conducción eléctrica}
\label{sec:org45e8d77}

\begin{frame}[label={sec:orgeae91c4}]{Bandas de energía}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org2b47c73}]{Bandas de energía}
\begin{center}
...
\begin{frame}[label={sec:org154773b}]{Conductores, aislantes y semiconductores}
...
\begin{frame}[label={sec:org417861b}]{Conductores, aislantes y semiconductores}
...
\label{sec:org8e59ad8}

\begin{frame}[label={sec:orge3bdc91}]{Red cristalina de Si (T = \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org601d7bd}]{Generación de electrón-hueco (T > \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\begin{frame}[plain,label={sec:org291dc57}]{Generación de electrón-hueco}
\begin{columns}
...
\begin{frame}[plain,label={sec:org7c3b66a}]{Recombinación de un par electrón-hueco}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org3528658}
\begin{frame}[label={sec:orgd9347b4}]{Definición}
...
\begin{frame}[label={sec:org017a854}]{Tipo n}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DopajeN.jpg}
\end{center}
\end{frame}

\begin{frame}[plain,label={sec:orga051f60}]{Tipo n}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org2464533}]{Tipo p}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/DopajeP.jpg}
\end{center}
\end{frame}

\begin{frame}[plain,label={sec:orgb2e32d6}]{Tipo p}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org6ed4563}
\begin{frame}[label={sec:org5d91983}]{Unión p-n}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orgc307f94}]{Conducción en una unión p-n}
\begin{itemize}
...
\begin{frame}[label={sec:org1896137}]{Corriente de Difusión}
\begin{itemize}
...
\begin{frame}[label={sec:org2e04df7}]{Corriente de Arrastre}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orge5171ba}]{Equilibrio en una unión p-n}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org1cdf241}]{Polarización en directa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:orgc44ded6}]{Polarización en inversa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\subsection{Diodo}
\label{sec:org558ef81}

\begin{frame}[label={sec:org8e29bc4}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org9b329ef}]{Ecuación del Diodo}
\begin{itemize}
...
\begin{frame}[label={sec:org3be41d3}]{}
\begin{center}
...
\label{sec:org3124570}

\begin{frame}[label={sec:orge58ed2b}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge26e80a}]{Efecto fotoeléctrico}
\begin{itemize}
...
\begin{frame}[label={sec:org8692ade}]{Absorción de luz y generación de portadores}
\begin{itemize}
...
\begin{frame}[label={sec:org4548f37}]{Absorción de luz y generación de portadores}
\begin{itemize}
...
\label{sec:org8e72069}

\begin{frame}[label={sec:org478fc73}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}
...
\label{sec:org61b0848}
\begin{frame}[label={sec:org0093e3f}]{Característica I-V de iluminación}
$$I=I_{L}-I_{D}$$
...
\begin{frame}[label={sec:org15e8181}]{Isc y Voc}
\begin{itemize}
...
\begin{frame}[label={sec:orge48d0ba}]{Punto de máxima potencia}
$$\frac{dP}{dV}=0$$
...
\begin{frame}[label={sec:org7885a64}]{Punto de máxima potencia}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CurvaIV_Ta20_G800.pdf}
\end{center}
...
\begin{frame}[label={sec:orgc0d3be7}]{Factor de forma y Eficiencia}
\begin{itemize}
...
\begin{frame}[plain,label={sec:orga6e7fa2}]{Eficiencia de células}
\begin{center}
...
\label{sec:orgc52f5b9}

\begin{frame}[label={sec:org40993bf}]{Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:org46b5cc6}]{Influencia de la Radiación}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CurvaIV_Ta20.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org86b57e9}]{Temperatura}
\begin{itemize}
...
\begin{frame}[label={sec:org9e4ae64}]{Influencia de Temperatura}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CurvaIV_G800.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7edb6ad}]{Condiciones Estándar de Medida}
\begin{itemize}
...
\label{sec:org76fd68d}

\begin{frame}[label={sec:org31dc930}]{Circuito equivalente}
\begin{center}
...
\begin{frame}[label={sec:org5621aea}]{Resistencia Serie: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org6b60836}]{Resistencia Serie: Curva PV}
\begin{itemize}
\item Resistencia de contactos metálicos con el semiconductor
...
\begin{frame}[label={sec:orgb64aaea}]{Resistencia paralelo: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org7aa892d}]{Resistencia paralelo: Curva PV}
\begin{itemize}
\item Fugas de corriente en bordes de célula
...
\label{sec:org356974e}

\begin{frame}[label={sec:org289ec87}]{Método de J.M. Ruiz}
\begin{itemize}
\item Normalización
\end{itemize}
...
\begin{frame}[label={sec:org54d22e0}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org94bfa79}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org10ba45a}]{Método de J.M. Ruiz}
\begin{itemize}
\item Itinerario
...
\begin{frame}[label={sec:orga8fd8e1}]{Simplificado: Factor de Forma Constante}
$$FF=FF^{*}$$
...
\begin{frame}[label={sec:orgc83e2a7}]{Ejercicio de Cálculo}
...
\section{Fabricación}
\label{sec:orgd1b384a}

\begin{frame}[label={sec:org4380828}]{}
\begin{center}
...
\begin{frame}[label={sec:org70e06b5}]{Purificación de silicio}
\begin{itemize}
...
\begin{frame}[label={sec:orgd932ff8}]{Formación de obleas}
\begin{itemize}
...
\begin{frame}[label={sec:org021b45a}]{Formación de células}
\begin{itemize}
