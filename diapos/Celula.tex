...
\label{sec:org37071f7}
\subsection{Conducción eléctrica}
\label{sec:orgd40b660}

\begin{frame}[label={sec:orga8dff89}]{Bandas de energía}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org1316060}]{Bandas de energía}
\begin{center}
...
\begin{frame}[label={sec:orgcb32dd1}]{Conductores, aislantes y semiconductores}
...
\begin{frame}[label={sec:org0190793}]{Conductores, aislantes y semiconductores}
...
\label{sec:org7105420}

\begin{frame}[label={sec:orgfcd1d15}]{Red cristalina de Si (T = \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgf369e84}]{Generación de electrón-hueco (T > \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:orgf73fa7b}]{Generación de electrón-hueco}
\begin{columns}
...
\begin{frame}[plain,label={sec:org3e3ccc0}]{Recombinación de un par electrón-hueco}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org4679ae3}
\begin{frame}[label={sec:org8f98dcc}]{Definición}
...
\begin{frame}[label={sec:org3c5b309}]{Tipo n}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:org0fea8ee}]{Tipo n}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org555808c}]{Tipo p}
\begin{center}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[plain,label={sec:org42ec9cd}]{Tipo p}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\label{sec:org600244b}
\begin{frame}[label={sec:org9b1de55}]{Unión p-n}
\begin{center}
\begin{center}
...
\begin{frame}[label={sec:orge8fbe20}]{Conducción en una unión p-n}
\begin{itemize}
...
\footnotetext[2]{Figura de Sedra and Smith, Microelectronic Circuits}
\end{frame}
\begin{frame}[label={sec:orgc9c0775}]{Corriente de Difusión}
\begin{itemize}
...
\begin{frame}[label={sec:org8cb6c90}]{Corriente de Arrastre}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org8d7c8af}]{Equilibrio en una unión p-n}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org9c68712}]{Polarización en directa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:org6ecd185}]{Polarización en inversa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\subsection{Diodo}
\label{sec:org63510a6}

\begin{frame}[label={sec:org81e096f}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org466f0ff}]{Ecuación del Diodo}
\begin{itemize}
...
\begin{frame}[label={sec:orgd38c408}]{}
\begin{center}
...
\label{sec:org260685f}

\begin{frame}[label={sec:orgd64576a}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0b18a1e}]{Efecto fotoeléctrico}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org11109cd}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org5ce0e03}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\label{sec:org8f77dd6}

\begin{frame}[label={sec:orga591127}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}
...
\label{sec:org1af7f26}
\begin{frame}[label={sec:org8026247}]{Característica I-V de iluminación}
$$I=I_{L}-I_{D}$$
...
\begin{frame}[label={sec:orgc296a14}]{Isc y Voc}
...
\begin{frame}[label={sec:org9df3d92}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:org143aef1}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:orgcb3ddde}]{Punto de máxima potencia}
...
\begin{frame}[label={sec:orgae5a306}]{Factor de forma y Eficiencia}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org87225ef}]{Eficiencia de células}
\begin{center}
...
\label{sec:orga52cbc3}

\begin{frame}[label={sec:orgf6ab0b6}]{Radiación}
\begin{itemize}
...
\begin{frame}[label={sec:org1415c0a}]{Influencia de la Radiación}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CurvaIV_Ta20.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgaeac995}]{Temperatura}
\begin{itemize}
...
\begin{frame}[label={sec:org88fdac5}]{Influencia de Temperatura}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CurvaIV_G800.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9932fee}]{Condiciones Estándar de Medida}
\begin{itemize}
...
\label{sec:org8cb6a03}

\begin{frame}[label={sec:orgf94ceb2}]{Circuito equivalente}
\begin{center}
...
\begin{frame}[label={sec:org27b8f8b}]{Resistencia Serie: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:orgff7b722}]{Resistencia Serie: Curva PV}
\begin{itemize}
\item Resistencia de contactos metálicos con el semiconductor
...
\begin{frame}[label={sec:orgd369f1c}]{Resistencia paralelo: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:orgc959424}]{Resistencia paralelo: Curva PV}
\begin{itemize}
\item Fugas de corriente en bordes de célula
...
\label{sec:org4a120e0}

\begin{frame}[label={sec:org7c24d56}]{Método de J.M. Ruiz}
\begin{itemize}
\item Normalización
\end{itemize}
...
\begin{frame}[label={sec:org0d09217}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org038e018}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:orgd5712c1}]{Método de J.M. Ruiz}
\begin{itemize}
\item Itinerario
...
\begin{frame}[label={sec:orgff6cf2e}]{Simplificado: Factor de Forma Constante}
$$FF=FF^{*}$$
...
\begin{frame}[label={sec:orgbe0fe46}]{Ejercicio de Cálculo}
...
\section{Fabricación}
\label{sec:orgd0823f8}

\begin{frame}[label={sec:org86545c2}]{}
\begin{center}
...
\begin{frame}[label={sec:org5209461}]{Purificación de silicio}
\begin{itemize}
...
\begin{frame}[label={sec:org60c2a36}]{Formación de obleas}
\begin{itemize}
...
\begin{frame}[label={sec:org8c2d759}]{Formación de células}
\begin{itemize}
