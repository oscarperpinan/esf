...
\label{sec:orgf7fbbb2}
\subsection{Conducción eléctrica}
\label{sec:org110a3a0}

\begin{frame}[label={sec:orgea60d73}]{Bandas de energía}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org977ae13}]{Bandas de energía}
\begin{center}
...
\begin{frame}[label={sec:orgb0099c0}]{Conductores, aislantes y semiconductores}
...
\begin{frame}[label={sec:org625142a}]{Conductores, aislantes y semiconductores}
...
\label{sec:org9aa89ee}

\begin{frame}[label={sec:org2b58e79}]{Red cristalina de Si (T = \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8b88c91}]{Generación de electrón-hueco (T > \SI{0}{\kelvin})}
\begin{center}
\begin{center}
...
\begin{frame}[plain,label={sec:orga5c49c0}]{Generación de electrón-hueco}
\begin{columns}
...
\begin{frame}[plain,label={sec:org3575161}]{Recombinación de un par electrón-hueco}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:org9ddefe5}]{Tipo n}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:orgffdbf47}]{Tipo p}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org6d7dfa4}]{Corriente de Difusión}
\begin{itemize}
...
\begin{frame}[label={sec:org697549f}]{Corriente de Arrastre}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org18f13c0}]{Equilibrio en una unión p-n}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org27aa6dc}]{Polarización en directa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\begin{frame}[plain,label={sec:orga457912}]{Polarización en inversa}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{itemize}[<+->]
...
\subsection{Diodo}
\label{sec:org7d3a66f}

\begin{frame}[label={sec:orgb9e7081}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org829e665}]{Ecuación del Diodo}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8c41b4}]{}
\begin{center}
...
\label{sec:org8656a70}

\begin{frame}[label={sec:org76812ac}]{}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/CelulaSolar.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org56476b0}]{Efecto fotoeléctrico}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orgdd5818d}]{Absorción de luz y generación de portadores}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:orge376bbd}]{Resistencia Serie: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:orge3ae809}]{Resistencia Serie: Curva PV}
\begin{itemize}
\item Resistencia de contactos metálicos con el semiconductor
...
\begin{frame}[label={sec:org2f9cf62}]{Resistencia paralelo: Curva IV}
\begin{itemize}
...
\begin{frame}[label={sec:org02cbb58}]{Resistencia paralelo: Curva PV}
\begin{itemize}
\item Fugas de corriente en bordes de célula
...
\label{sec:orged2abe7}

\begin{frame}[label={sec:org63b78fc}]{Método de J.M. Ruiz}
\begin{itemize}
\item Normalización
\end{itemize}
...
\begin{frame}[label={sec:org96b47d9}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org4279112}]{Método de J.M. Ruiz}
\begin{itemize}
...
\begin{frame}[label={sec:org68a88cb}]{Método de J.M. Ruiz}
\begin{itemize}
\item Itinerario
...
\begin{frame}[label={sec:org66e6f6c}]{Simplificado: Factor de Forma Constante}
$$FF=FF^{*}$$
...
\begin{frame}[label={sec:org7572a60}]{Ejercicio de Cálculo}
...
\begin{frame}[label={sec:orgbd93cd1}]{Formación de células}
\begin{itemize}
