...
\begin{frame}[label={sec:orgd552fe1}]{}
\begin{center}
...
\subsection{SFCR}
\label{sec:org42c8fe0}

\begin{frame}[label={sec:orgb1e1a7d}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:orgf270718}]{Tipos de SFCR}
...
\begin{frame}[label={sec:org30b4b04}]{Sistemas sobre Suelo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/Photocampa.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb768b0f}]{Sistemas en Edificación}
\begin{center}
...
\label{sec:orgef5b203}
\begin{frame}[label={sec:orgd89db37}]{Definición}
\begin{itemize}
...
\begin{frame}[label={sec:org0333b82}]{Aplicaciones profesionales}
\begin{itemize}
...
\begin{frame}[label={sec:org82f8fcb}]{}
\begin{center}
\includegraphics[height=0.95\textheight]{../figs/TelefoniaRural.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4e568d4}]{Sistemas de Electrificación Rural}
\begin{itemize}
...
\begin{frame}[label={sec:org38e0d7a}]{SHS}
\begin{itemize}
...
\begin{frame}[label={sec:orgb802312}]{Híbridos}
\begin{itemize}
...
\begin{frame}[label={sec:org2f5ae36}]{Aplicaciones pequeño consumo}
...
\label{sec:org149fe87}
\begin{frame}[label={sec:org372a702}]{Definición}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org631cc4c}]{}
\begin{center}
...
\label{sec:org8d423c7}

\subsection{Mercado Fotovoltaico}
\label{sec:orgecbf22a}
...
\begin{frame}[label={sec:org1a65e40}]{Paridad en 2010\footnote{El color naranja identifica los sistemas residenciales y el azul los
...
\begin{frame}[label={sec:org46eef24}]{Paridad en 2013\footnote{El color naranja identifica los sistemas residenciales y el azul los
sistemas industriales. El tamaño de los círculos está relacionado con
el tamaño del mercado eléctrico de cada país.}}
\begin{center}
...
\label{sec:org5850f63}

\begin{frame}[label={sec:org5e860d2}]{Segmentos de Mercado}
\begin{itemize}
...
\begin{frame}[label={sec:org846ae71}]{Segmentación en Alemania y España}
\begin{itemize}
...
\begin{frame}[label={sec:org00d3e2f}]{Tamaño de instalación y Conexión}
\begin{block}{España}
\begin{itemize}
