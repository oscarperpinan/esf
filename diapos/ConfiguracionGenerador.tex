...
\begin{frame}[label={sec:org2403ad0}]{Configuración del generador}
...
\begin{frame}[label={sec:org55ba8e9}]{Configuración eléctrica y estructura}
\begin{itemize}
...
\begin{frame}[label={sec:org2d0b3dd}]{Inversión y rendimiento económicos}
\begin{itemize}
...
\begin{frame}[label={sec:org581f758}]{Terreno ocupado}
\begin{itemize}
...
\begin{frame}[label={sec:org38190bf}]{Relación de potencias entre generador e inversor}
...
\begin{frame}[label={sec:org5aa4e74}]{Relación de potencias entre generador e inversor}
\begin{itemize}
