...
\label{sec:orgcef0ce4}

\begin{frame}[label={sec:org8e064de},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/ConfiguracionGenerador.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4edf5e5},plain]{Planteamiento}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgec73f35}]{Modulos en serie}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgce7da57}]{Procedimiento de cálculo}
...
\begin{frame}[label={sec:org9a086db}]{Procedimiento de cálculo}
...
\]
\end{frame}
\begin{frame}[label={sec:org154bb18}]{Procedimiento de cálculo}
\framesubtitle{Tensión MPP}
...
\]
\end{frame}
\begin{frame}[label={sec:org11ecd5e}]{Ramas en paralelo}
\begin{itemize}
...
\begin{frame}[label={sec:org1a4ba09}]{Configuración del generador}
...
\begin{frame}[label={sec:orgc744b66}]{Configuración eléctrica y estructura}
\begin{itemize}
...
\begin{frame}[label={sec:orgabe5a60}]{Inversión y rendimiento económicos}
\begin{itemize}
...
\begin{frame}[label={sec:org8b15d40}]{Terreno ocupado}
\begin{itemize}
...
\begin{frame}[label={sec:org1d534aa}]{Relación de potencias entre generador e inversor}
...
\begin{frame}[label={sec:orgca6c66b}]{Relación de potencias entre generador e inversor}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2df47f}]{Relación de potencias entre generador e inversor}
\begin{itemize}
...
\label{sec:orgd5082ee}

\begin{frame}[label={sec:org3919c59},plain]{}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CableadoCentral.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org1fc07cc}]{Características básicas}
\begin{itemize}
