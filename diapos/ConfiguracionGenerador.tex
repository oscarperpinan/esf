...
\label{sec:org81caf23}

\begin{frame}[label={sec:orgba90dca},plain]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/ConfiguracionGenerador.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3407320},plain]{Planteamiento}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd0560dd}]{Modulos en serie}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org840b059}]{Procedimiento de cálculo}
...
\begin{frame}[label={sec:org4a53dc3}]{Procedimiento de cálculo}
...
\]
\end{frame}
\begin{frame}[label={sec:org0b58eb3}]{Procedimiento de cálculo}
\framesubtitle{Tensión MPP}
...
\]
\end{frame}
\begin{frame}[label={sec:org6ef8e67}]{Ramas en paralelo}
\begin{itemize}
...
\begin{frame}[label={sec:orgb953ff0}]{Configuración del generador}
...
\begin{frame}[label={sec:org4a13f85}]{Configuración eléctrica y estructura}
\begin{itemize}
...
\begin{frame}[label={sec:org2164fd5}]{Inversión y rendimiento económicos}
\begin{itemize}
...
\begin{frame}[label={sec:org602aae4}]{Terreno ocupado}
\begin{itemize}
...
\begin{frame}[label={sec:org9dc7b3d}]{Relación de potencias entre generador e inversor}
...
\begin{frame}[label={sec:org6db85c4}]{Relación de potencias entre generador e inversor}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8b6093}]{Relación de potencias entre generador e inversor}
\begin{itemize}
...
\label{sec:orgaa6596a}

\begin{frame}[label={sec:orgfb8e271},plain]{}
\begin{center}
\includegraphics[width=\textwidth]{../figs/CableadoCentral.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9e368c9}]{Características básicas}
\begin{itemize}
