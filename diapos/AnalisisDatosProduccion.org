...
- Sea $\overline{Y}_{f}(t)$ la serie temporal del promedio de la productividad diaria del SFV.
- Tomando $\overline{Y}_{f}(t)$ como modelo o referencia, podemos emplear los diagramas de Taylor y Target para detectar unidades defectuosas.
