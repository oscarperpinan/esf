...
\hypersetup{
 ...
 pdfkeywords={},
 pdfsubject={},
 pdfcreator={Emacs 25.2.2 (Org mode 9.1)}, 
 pdflang={Spanish}}
\begin{document}
...
\begin{frame}[label={sec:org1fd2769}]{Eficiencia y Rendimiento}
\begin{description}
...
\label{sec:org727f66a}
\begin{frame}[label={sec:org2e51f56}]{Generadores}
\begin{itemize}
...
\begin{frame}[label={sec:org2e9976c}]{Resistencia}
\begin{center}
...
\begin{frame}[label={sec:orgdb158fb}]{Resistencia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Resistencia.pdf}
\end{center}
...
\begin{frame}[label={sec:org8e19608}]{Bobina o inductancia}
\begin{center}
...
\begin{frame}[label={sec:org602983f}]{Bobina o inductancia}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Bobina.pdf}
\end{center}
...
\begin{frame}[label={sec:org6681675}]{Condensador}
\begin{center}
...
\begin{frame}[label={sec:orge92a8b6}]{Condensador}
\begin{center}
\includegraphics[height=0.2\textheight]{../figs/Condensador.pdf}
\end{center}
...
\label{sec:org3b41124}
\begin{frame}[label={sec:org0eb727e}]{Diodo}
\begin{center}
...
\begin{frame}[label={sec:org64e284e}]{Diodo}
\begin{center}
\includegraphics[height=0.15\textheight]{../figs/Diodo.pdf}
\end{center}
...
\begin{frame}[label={sec:orgebf009f}]{Transistor}
\begin{center}
...
\begin{frame}[label={sec:org4294951}]{Transistor}
\begin{center}
\includegraphics[height=0.3\textheight]{../figs/Transistor.pdf}
\end{center}
...
\label{sec:orgefd85c5}
\begin{frame}[label={sec:org3aea700}]{Conexión en serie}
...
\begin{frame}[label={sec:org36b554f}]{Conexión en paralelo}
...
\begin{frame}[label={sec:org50dbcf7}]{Circuito Capacitivo puro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlotCircuitoCapacitivoPuro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org18609c9}]{Circuito Inductivo puro}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlotCircuitoInductivoPuro.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3a59c0a}]{Circuito Capacitivo}
\begin{center}
\includegraphics[width=.9\linewidth]{../figs/PlotCircuitoCapacitivo.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org42e978e}]{Circuito Inductivo}
\begin{center}
...
\subsection{Potencia}
\label{sec:orgc6ee297}
\begin{frame}[label={sec:orgebd8822}]{Circuito Capacitivo puro}
...
\begin{frame}[label={sec:orgf1d5dc6}]{Circuito Inductivo puro}
\begin{block}{Potencia}
\begin{center}
...
\begin{frame}[label={sec:orgff5de3a}]{Circuito Capacitivo}
\begin{block}{Potencia}
\begin{center}
...
\begin{frame}[label={sec:org107c249}]{Circuito Inductivo}
\begin{block}{Potencia}
\begin{center}
...
\begin{frame}[label={sec:orgf7ab076}]{Potencia Activa, Reactiva y Aparente}
$$\begin{aligned}
...
\begin{frame}[label={sec:org1cc257b}]{Potencia de elementos}
\begin{itemize}
...
\begin{frame}[label={sec:org6e0aa5c}]{Motores}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfe4c62b}]{Generadores}
...
\begin{frame}[label={sec:org818f1b4}]{Generadores}
\begin{block}{Dinamo}
\begin{itemize}
\item \(f_{1}=0\); \(f_{L}=0\);
...
\label{sec:orgff04b7d}
\subsection{Definición y Funciones}
\label{sec:org0c44572}
\begin{frame}[label={sec:org15c45ad}]{Definición}
...
\begin{frame}[label={sec:org27a708a}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:org50cd8ec}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:orgd59e5f5}]{Funciones de la aparamenta}
\begin{itemize}
...
\begin{frame}[label={sec:org3a2cc72}]{Arco Eléctrico}
\begin{itemize}
...
\begin{frame}[label={sec:org42737d2}]{Poder de corte y cierre}
\begin{description}
...
\label{sec:org8b35504}
\begin{frame}[label={sec:orgfce47d7}]{Dispositivos simples}
...
\begin{frame}[label={sec:org8551e7f}]{Dispositivos simples}
...
\begin{frame}[label={sec:org7f8b092}]{Interruptor magnetotérmico}
\begin{itemize}
...
\begin{frame}[label={sec:orgfddf3e8}]{Interruptor Magnetotérmico}
\begin{center}
\includegraphics[height=0.8\textheight]{../figs/SeccionMagnetotermico.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb2831dd}]{Interruptor diferencial}
\begin{itemize}
...
\begin{frame}[label={sec:org9b18b49}]{Interruptor Diferencial}
\begin{center}
