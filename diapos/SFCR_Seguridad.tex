...
\begin{frame}[label={sec:org62a3ad2}]{Clases de materiales}
...
\begin{frame}[label={sec:org9cd8312}]{Clases de materiales}
...
\begin{frame}[label={sec:org3916266}]{Tensión de contacto y defecto}
...
\begin{frame}[label={sec:org7718a72}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:orgbbb0590}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:orgdc2770a}]{Esquemas de conexión a tierra}
...
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/ContactoDirectoIT_Capacidad.pdf}
\end{center}
...
\label{sec:orgb1c0e4a}


\begin{frame}[label={sec:org616c915}]{REBT: Contactos Indirectos}
...
\begin{frame}[label={sec:org8e94a56}]{Contacto Indirecto IT}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org62b50a5}]{Contacto Indirecto TT}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org31a826c}


\begin{frame}[label={sec:org6e5cdd3}]{Tres niveles de protección}
...
\begin{frame}[label={sec:org72d54af}]{Nivel 1: Refuerzo del aislamiento de las partes activas.}
\begin{description}
...
\begin{frame}[label={sec:org05aea5d}]{Fusibles}
\begin{itemize}
...
\begin{frame}[label={sec:orge860206}]{Descargadores de tensión}
\begin{itemize}
...
\label{sec:org95ef586}
\begin{frame}[label={sec:orgb642c4d}]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CajaAC.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org076d92c}]{Cortocircuitos y sobrecargas}
\begin{itemize}
...
\begin{frame}[label={sec:org3e39ece}]{Cortocircuitos y sobrecargas}
\begin{itemize}
...
\begin{frame}[label={sec:org9576e12}]{Interruptor diferencial}
\begin{itemize}
