...
\label{sec:orgcbaa22e}

\begin{frame}[label={sec:org93e162e}]{Contacto Directo e Indirecto}
\begin{description}
...
\begin{frame}[label={sec:org322c179}]{Masa y Tierra}
\begin{description}
...
\begin{frame}[label={sec:org0ce1ce7}]{Tensión de contacto y defecto}
...
\begin{frame}[label={sec:orgfeb1e3f}]{Clases de materiales}
\begin{itemize}
...
\begin{frame}[label={sec:org27169bb}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:org502926b}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:org3b04d6a}]{Esquemas de conexión a tierra}
...
\label{sec:org5a80496}

\subsection{Efectos de la corriente eléctrica}
\label{sec:orgb8a0a6d}

\begin{frame}[label={sec:org3424d40}]{Intensidad y tiempo de contacto}
\begin{itemize}
...
\begin{frame}[label={sec:org33ec908}]{Frecuencia eléctrica}
\begin{itemize}
\item Continua:
...
\label{sec:orgdae0020}


\begin{frame}[label={sec:org9cab1bf}]{REBT: Contactos Indirectos}
...
\begin{frame}[label={sec:org9d14c75}]{Contacto Indirecto IT}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3409879}]{Contacto Indirecto TT}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org767516b}


\begin{frame}[label={sec:orge28ac07}]{Tres niveles de protección}
...
\begin{frame}[label={sec:orgf6ff4e2}]{Nivel 1: Refuerzo del aislamiento de las partes activas.}
\begin{description}
...
\begin{frame}[label={sec:org874f3cc}]{Fusibles}
\begin{itemize}
...
\begin{frame}[label={sec:org304960b}]{Descargadores de tensión}
\begin{itemize}
...
\label{sec:orgd4ad266}
\begin{frame}[label={sec:org055ac5f}]{}
\begin{center}
\includegraphics[height=0.9\textheight]{../figs/CajaAC.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org565c198}]{Cortocircuitos y sobrecargas}
\begin{itemize}
...
\begin{frame}[label={sec:org4b5f4f3}]{Cortocircuitos y sobrecargas}
\begin{itemize}
...
\begin{frame}[label={sec:org01c7551}]{Interruptor diferencial}
\begin{itemize}
...
\begin{frame}[label={sec:orgcb2a12e}]{Puesta a tierra}
\begin{itemize}
...
\label{sec:org88661ba}

\begin{frame}[label={sec:orgbc8c581}]{Tomas de tierra existentes}
...
\begin{frame}[label={sec:org610df0b}]{Cálculo de resistencia para generador}
\begin{itemize}
...
\begin{frame}[label={sec:orgc6808ad}]{Cálculo de la resistencia de tierra}
\begin{itemize}
...
\begin{frame}[label={sec:org2534d35}]{Cálculo de la resistencia de tierra}
\begin{itemize}
...
\begin{frame}[label={sec:org6dd4912}]{Ejemplo}
\begin{itemize}
...
\begin{frame}[label={sec:org105026f}]{Ejemplo}
\begin{itemize}
