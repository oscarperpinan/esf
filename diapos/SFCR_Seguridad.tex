...
\begin{frame}[label={sec:orgfb0dd61}]{Clases de materiales}
...
\begin{frame}[label={sec:orge705960}]{Clases de materiales}
...
\begin{frame}[label={sec:orgea6c7ea}]{Tensión de contacto y defecto}
...
\begin{frame}[label={sec:org351dec8}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:orgeb1b042}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:org8bb9d2d}]{Esquemas de conexión a tierra}
...
\begin{frame}[label={sec:org2b1a7bd}]{Nivel 1: Refuerzo del aislamiento de las partes activas.}
\begin{description}
...
\begin{frame}[label={sec:org781e3ba}]{Nivel 2: Sistema de detección de aislamiento.}
\begin{description}
...
\begin{frame}[label={sec:org97b1f57}]{Nivel 3: Protección en caso de fallo de los niveles 1 y 2:}
\begin{description}
