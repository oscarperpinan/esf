...
\label{sec:orgce564ed}

\begin{frame}[label={sec:org35e36de}]{Contacto Directo e Indirecto}
\begin{description}
...
\begin{frame}[label={sec:orgad8d6c3}]{Masa y Tierra}
\begin{description}
...
\begin{frame}[label={sec:org51a16a5}]{Tensión de contacto y defecto}
...
\begin{frame}[label={sec:orgf0e5233}]{Clases de materiales}
\begin{itemize}
...
\begin{frame}[label={sec:org3fe4154}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:orga95031b}]{Esquemas de conexión a tierra}
\begin{description}
...
\begin{frame}[label={sec:orga4379d3}]{Esquemas de conexión a tierra}
...
\label{sec:org90200d1}

\subsection{Efectos de la corriente eléctrica}
\label{sec:org3a6d68d}

\begin{frame}[label={sec:org6a64ecc}]{Intensidad y tiempo de contacto}
\begin{itemize}
...
\begin{frame}[label={sec:org51f86c0}]{Frecuencia eléctrica}
\begin{itemize}
\item Continua:
...
\begin{frame}[label={sec:org24fbbc2}]{Cálculo de la resistencia de tierra}
\begin{itemize}
...
\begin{frame}[label={sec:org3a86d1d}]{Cálculo de la resistencia de tierra}
\begin{itemize}
...
\begin{frame}[label={sec:org0b6fc54}]{Ejemplo}
\begin{itemize}
...
\begin{frame}[label={sec:orge4adce1}]{Ejemplo}
\begin{itemize}
