...
sistemas de autoconsumo en España se detallan:
  ...
  - Guía Técnica de Aplicación del REBT: Instalaciones Generadoras de Baja Tensión (ITC-BT-40).
  - Anexo III (Modos de Conexión) de la Guía Profesional del Autoconsumo del IDAE.

En estos documentos se recopila el catálogo de posibilidades según:
- tipo de autoconsumo (individual o colectivo)
- tipo de conexión (en red interior o a través de red).
